...
WORD_RE = re_u.compile(r"\p{L}+(?:[\p{Mn}\p{Mc}]*)", re_u.UNICODE)
...
def main() -> int:
    ...
    ap.add_argument("--raw-dir", default="gamma/projects/embeddinggemma_subsets/data/raw")
    ap.add_argument("--seed-dir", default="gamma/projects/embeddinggemma_subsets/data")
    ap.add_argument("--corpora-dir", default="gamma/projects/embeddinggemma_subsets/data/corpora")
    ap.add_argument("--datasets-dir", default="gamma/projects/embeddinggemma_subsets/datasets")
