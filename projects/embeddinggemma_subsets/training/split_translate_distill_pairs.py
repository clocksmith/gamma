...
projects/distillation/translation/training/, emitting a deprecation warning.
"""
...
def _target_script() -> Path:
    return _repo_root() / "projects" / "distillation" / "translation" / "training" / "split_translate_distill_pairs.py"
