...
projects/distillation/translation/eval/, emitting a deprecation warning.
"""
...
def _target_script() -> Path:
    return _repo_root() / "projects" / "distillation" / "translation" / "eval" / "run_translate_distill_eval.py"
