...
def main() -> int:
    ...
    ap.add_argument("--datasets-dir", default="gamma/projects/distillation/embedding/datasets_hard_v3")
    ...
    ap.add_argument("--out", default="gamma/projects/distillation/embedding/training_data/distill_pairs.jsonl")
    args = ap.parse_args()
