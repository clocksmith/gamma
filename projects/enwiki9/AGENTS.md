...
- The [active v4 objective](contracts/research/v4/objective-contract.json) is
  ...
  score at or below **96,000,000 bytes**. Preserve historical objective digests
...
When explicitly asked for Hutter status, include the `96,000,000` byte and
`9.6000000%` targets, the verified full-1G score or `unknown`, the best counted
