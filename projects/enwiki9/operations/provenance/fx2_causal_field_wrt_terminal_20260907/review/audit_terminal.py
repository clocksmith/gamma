...
def main():
 ...
 output = {'schema': 'gamma.enwiki9.independent-field-terminal-audit.v1', 'status': 'failed',
  ...
  'limits': {'cpu': [4], 'memory_bytes': 536870912, 'cpu_seconds': 60, 'wall_seconds': 90,
             'scratch_bytes': 268435456, 'input_read_bytes': READ_CAP}}
 try:
  require(os.sched_getaffinity(0) == {4}, 'terminal reviewer must run on CPU4')
  audit(args, output)
