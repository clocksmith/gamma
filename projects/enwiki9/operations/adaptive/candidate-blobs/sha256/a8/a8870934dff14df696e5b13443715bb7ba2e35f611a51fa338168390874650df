#!/usr/bin/env python3
"""Verify the v3 program lock while owning the managed lane namespace."""
...
def main() -> int:
    ...
    tool = load_tool(PROJECT, "gamma_mechanism_ir_program_lock_verify.py", "gamma_ir_v3_lock_verifier_frozen")
