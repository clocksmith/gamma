...
def adapt(source_zip: Path, library: Path):
    ...
    additions={'src/gamma-relational-runtime.h':runtime_header().encode(),**{'src/'+n:(library/n).read_bytes() for n in ['predictors/causal_relational_v2.hpp','fx2_xml_field_observer_v1.hpp']}}
