...
- Objective: `gamma-enwiki9-hutter-90m-v3` (`sha256:e91ff20e92c3cac8acb0cbe5c79fc8e8a3b427d7e151245c8eecc52b1c32fa00`).
- Target: `90,000,000` bytes (`9.0000000%`).
...
| Candidate run | Tier | Status | Population | Archive | Gain | B/M | Package | Forecast | Margin | Proof |
|---|---|---|---|---:|---:|---:|---:|---:|---:|---|
| `endpoint428_gate_dot_fuse_output_update_loop_v1__10000000` | `constructive_prefix` | `active` | opening_prefix | 1,634,500 | 1,195 | 119.500 | 261,125 | 109,389,323 (10.9389323%) | -19,389,323 | RT=true, DET=true |
| `endpoint428_pair_layer0_online_residual_successor__10000000` | `constructive_prefix` | `retired_unchanged` | opening_prefix | 1,635,174 | 521 | 52.100 | 278,825 | 109,452,151 (10.9452151%) | -19,452,151 | not recorded |
| `endpoint428_context_recovery_10m__10000000` | `constructive_prefix` | `retired_unchanged` | unspecified | 1,635,695 | 1,818 | 181.800 | 349,195 | 109,557,404 (10.9557404%) | -19,557,404 | not recorded |
| `heterogeneous_112_plus_80__10000000` | `constructive_prefix` | `retired_unchanged` | unspecified | 1,635,670 | 7,956 | 795.600 | 264,646 | 109,498,879 (10.9498879%) | -19,498,879 | not recorded |
...
| Candidate run | Tier | Status | Population | Archive | Gain | B/M | Package | Forecast | Margin | Proof |
|---|---|---|---|---:|---:|---:|---:|---:|---:|---|
| `endpoint428_compact_layer0_phase_native_pruned_v3__1m_prefix` | `constructive_prefix` | `active` | opening_prefix | 174,099 | -136 | -136.000 | 235,420 | 109,499,618 (10.9499618%) | -19,499,618 | RT=true, DET=true |
...
| `endpoint428_pair_layer0_online_residual_successor__1m_offset500m` | `constructive_prefix` | `retired_unchanged` | cold_reset_disjoint_window | 45,051 | 89 | 89.000 | 350,942 | 109,470,151 (10.9470151%) | -19,470,151 | not recorded |
| `endpoint428_pair_layer0_online_residual_successor__1m_prefix` | `constructive_prefix` | `retired_unchanged` | opening_prefix | 173,896 | 67 | 67.000 | 350,942 | 109,492,151 (10.9492151%) | -19,492,151 | RT=true, DET=true |
