"""Reuse the fixed source-ZIP diagnostic on the compact parent and wiki slot."""
import hashlib
...
module.SOURCES = {
    ...
    'treatment': ('opcode_wiki_slot_v1', {
        'p': '7d331ba82c635af8afe6517bf5f4471b41dcf7854c6ec01cb5564078d9bb56a8',
        'program.py': '93514bf36ed453e84ad211bfb6121a56363b90c74c6c327f581e86f952341bce'})}
module.main()
out = Path(sys.argv[1]).resolve()
receipt = json.loads((out/'receipt.json').read_text())
counts = {r['name']: r['source_zip']['bytes'] for r in receipt['rows']}
wrapper = dict(schema='gamma.enwiki9.opcode-wiki-slot-source-cost.v1',
