...
bool RunCompression(bool enable_preprocess, const std::string& input_path,
  ...
  *input_bytes = ftell(data_in);
  ...
  gamma_relation_runtime::begin(dictionary, gamma_static_frontend ? gamma_literal_header : nullptr, *input_bytes);
...
bool RunDecompression(const std::string& input_path,
  ...
  *input_bytes = data_in.tellg();
  ...
  if (gamma_static_frontend) temp_out.write(gamma_literal_header, 5);
  gamma_relation_runtime::begin(dictionary, gamma_static_frontend ? gamma_literal_header : nullptr, 0);
