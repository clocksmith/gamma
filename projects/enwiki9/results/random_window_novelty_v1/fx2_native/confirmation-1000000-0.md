...
- Raw archive: `184336` bytes
- Title-echo archive: `184683` bytes
- Candidate delta: `+347` bytes
- Gross gain: `-347.000` B/1M
- Transform size delta: `-22416` bytes
- Raw roundtrip: `true`
...
|---|---:|---:|---|
| `identity_compress_a` | 0 | 5779876 | `complete` |
| `candidate_compress_a` | 0 | 5783164 | `complete` |
| `identity_decompress` | 0 | 5779716 | `complete` |
| `candidate_decompress` | 0 | 5782564 | `complete` |
| `identity_compress_b` | 0 | 5780036 | `complete` |
| `candidate_compress_b` | 0 | 5783072 | `complete` |
