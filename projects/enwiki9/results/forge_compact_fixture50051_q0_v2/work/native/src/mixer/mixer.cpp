...
#ifndef FX3_MIXER_CONTEXT_LIMIT
#define FX3_MIXER_CONTEXT_LIMIT 10000
#endif

static_assert(FX3_MIXER_CONTEXT_LIMIT > 0,
              "FX3_MIXER_CONTEXT_LIMIT must be positive");
...
ContextData* Mixer::GetContextData() {
  ContextData* data;
  unsigned long long limit = FX3_MIXER_CONTEXT_LIMIT;
...
void Mixer::Perceive(int bit) {
  FX3_PROFILE_SCOPE("mixer.perceive");
