...
#ifndef FX3_MIXER_CONTEXT64
#define FX3_MIXER_CONTEXT64 0
#endif

#if FX3_MIXER_CONTEXT64
using MixerContextKey = unsigned long long;
#else
using MixerContextKey = unsigned int;
#endif
...
class Mixer {
 ...
 private:
  ...
  emhash6::HashMap<MixerContextKey, ContextData> context_map_;
