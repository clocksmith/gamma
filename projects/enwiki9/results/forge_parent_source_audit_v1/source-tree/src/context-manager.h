...
struct ContextManager {
  ...
  void UpdateTemplatePhaseContext();
  void RefreshTemplatePhaseBitContexts();
#endif
  ...
  unsigned long long long_bit_context_ = 1, zero_context_ = 0, history_pos_ = 0,
      ...
      mx17=0,mx17cxt=0,
      mx18=0,mx18cxt=0,
      lstm_lowprob_state_=0,lstm_lowprob_context_=0,
      lstm_mixer_context_=0,
      mxx=0,
      words=0,wordscxt=0,
      ...
      mx19cxt=0;
#ifdef ENABLE_TEMPLATE_PHASE_CONTEXT
  static constexpr unsigned int kTemplatePhaseStackCap = 16;
  unsigned char template_phase_stack_[kTemplatePhaseStackCap] = {};
  unsigned char template_phase_tpl_line_col_[kTemplatePhaseStackCap] = {};
  unsigned char template_phase_tpl_sig_[kTemplatePhaseStackCap] = {};
  unsigned char template_phase_tpl_saw_pipe_[kTemplatePhaseStackCap] = {};
  unsigned char template_phase_tpl_saw_equals_[kTemplatePhaseStackCap] = {};
  unsigned char template_phase_active_target_ = 0;
  unsigned long long template_phase_stack_size_ = 0,
      template_phase_tpl_depth_ = 0, template_phase_seen_bytes_ = 0,
      template_phase_context_ = 0, template_phase_shape_context_ = 0;
#endif
