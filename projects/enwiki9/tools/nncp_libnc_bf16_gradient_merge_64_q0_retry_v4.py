#!/usr/bin/env python3
"""Retry the full-config merge oracle with BF16 matmul injection."""
...
MATERIALIZER = ROOT / (
    "tools/nncp_libnc_bf16_gradient_merge_64_q0_retry_v4_materializer.py"
)
PROGRAM_DESCRIPTOR = PROGRAM / "program.py"
EVALUATOR_SOURCE = PROGRAM / "gradient_merge_matmul.c"
