#!/usr/bin/env python3
"""Retry the streaming-dot open top-FF2 tail with inherited bindings intact."""
...
FREEZER = ROOT / (
    "tools/nncp_open_profile_top_ff2_gradient_stream_dot_64_q0_retry_v1_materializer.py"
)
