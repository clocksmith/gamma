...
DEFAULT_PROGRAMS = [
    ...
    "fx2_order_selector_sidecar_byte_split_direct_extra_page_match_v1",
    "fx2_geometry_title_sidecar_byte_split_direct_extra_page_match_v1",
    "fx2_timestamp_direct_byte_split_extra_page_match_v1",
    "fx2_timestamp_direct_only_byte_split_extra_page_match_v1",
    "fx2_sidecar_byte_split_direct_extra_page_match_v1",
    "fx2_sidecar_byte_split_direct_extra_page_match_dictcmix_xz_min_v1",
...
PROGRAM_CONCEPTS: dict[str, dict] = {
    ...
    "fx2_sidecar_byte_split_direct_extra_page_match_dictcmix_xz_min_v1": {
        ...
        "notes": "Packaging-only xz/dictcmix min wrapper for the broad sidecar archive leader.",
    },
    "fx2_geometry_title_sidecar_byte_split_direct_extra_page_match_v1": {
        "lane": "destructive_geometry_fx2_sc_sidecar",
        "concepts": [
            "rate_ledger",
            "reversible_geometry_sort",
            "schema_template_ctx",
            "soft_symbol_reduction",
            "lexical_priming",
            "namespace_page_kind",
        ...
        "notes": "Exact-input selector over raw and geometry/title page order paths around the strongest measured broad FX2-SC backend.",
    },
    "fx2_order_selector_sidecar_byte_split_direct_extra_page_match_v1": {
        "lane": "destructive_geometry_fx2_sc_sidecar",
        "concepts": [
        ...
        "notes": "Exact-input selector over raw plus multiple reversible page-order keys around the strongest measured broad FX2-SC backend.",
    },
    "fx2_timestamp_direct_byte_split_extra_page_match_v1": {
        "lane": "fx2_sc_sidecar",
        "concepts": [
        ...
        "notes": "Broad sidecar backend with an added XML timestamp position/class context.",
    },
    "fx2_timestamp_direct_only_byte_split_extra_page_match_v1": {
        "lane": "fx2_sc_sidecar",
        "concepts": [
        ...
        "notes": "Size-oriented direct-only timestamp context on the broad sidecar backend.",
    },
