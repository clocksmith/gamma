#!/usr/bin/env python3
"""V14 opening-1M identity envelope with lifecycle-safe telemetry."""
...
CGROUP_BASE = Path("/sys/fs/cgroup/user.slice/user-1000.slice/user@1000.service/app.slice/gamma-cmix-obias-env8192-opening1m-q0-v14")
...
def preflight(arguments: Any) -> tuple[dict[str, Any], dict[str, Path]]:
    ...
    report["schema"] = "gamma.enwiki9.cmix-obias-opening1m-preflight.v14"
...
V10.SCHEMA = "gamma.enwiki9.cmix-obias-source-ppm-rss-env8192-opening1m-decision.v14"
...
V10.V3.STAGE_SCHEMA = "gamma.enwiki9.cmix-obias-source-ppm-rss-env8192-opening1m-stage.v14"
