#!/usr/bin/env python3
"""Run the snapshot-bound HARM-Delta scope-coordinate source fixture.

This wrapper exposes no production input arguments. It cannot name or open
canonical corpus data, production Endpoint428 inputs, or the live HORIZON
result namespace.
"""
