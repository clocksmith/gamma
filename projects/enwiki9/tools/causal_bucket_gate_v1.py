...
SELF, CODEC = 'tools/causal_bucket_gate_v1.py', 'tools/causal_bucket_v1.py'
PLAIN, DECODER = 'tools/dualstream_grammar_argtokens_v2.py', 'tools/dualstream_grammar_decode_dispatch_v1.py'
SHARED_DRIVER, TESTS = 'tools/dualstream_grammar_gate_v1.py', 'tests/test_causal_bucket_gate_v1.py'
...
def validate_plan(plan, candidate):
    ...
    codec = importlib.import_module('tools.causal_bucket_v1')
