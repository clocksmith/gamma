#!/usr/bin/env python3
"""Guarded causal residual bound and conditional finite arithmetic replay."""
import hashlib
import json
import os
...
CID='fx2_causal_residual250k_v1'
...
def main():
    ...
    if (snapshot/'program.py').read_bytes()!=(ROOT/'tools'/('fx2_causal_residual250k_v1.py')).read_bytes():raise ValueError('sealed source differs')
