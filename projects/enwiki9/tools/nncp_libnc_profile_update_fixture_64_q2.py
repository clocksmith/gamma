#!/usr/bin/env python3
"""Retry the production update fixture with save-time parameter naming."""

from pathlib import Path

import nncp_libnc_profile_update_fixture_64_q1 as parent


base = parent.base
CANDIDATE_ID = "nncp_libnc_profile_update_fixture_64_q2_v1"
base.CANDIDATE_ID = CANDIDATE_ID
base.HOOK = base.ROOT / "tools/nncp_profile_update_fixture_hook_q2.c"
