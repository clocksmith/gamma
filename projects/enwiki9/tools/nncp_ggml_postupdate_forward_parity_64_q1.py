...
CANDIDATE_ID = "nncp_ggml_postupdate_forward_parity_64_q1_v1"
...
def main() -> int:
    ...
    comparisons, branch = base.compare_forward(fixture, manifest, run_a)
    repeat_identical = base.aggregate(run_a) == base.aggregate(run_b)
    repeat_comparisons, repeat_branch = base.compare_forward(fixture, manifest, run_b)
