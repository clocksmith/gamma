...
ID = "fx2_cmix_transformer_gcc_fixture50051_q0_v2"
...
def stage() -> int:
    ...
    audit = verify()
    work = RESULT / "work"
    materializer_path = PROJECT / "tools/fx2_cmix_transformer_gcc_fixture50051_q0_v2_materializer.py"
    ...
    spec = importlib.util.spec_from_file_location("public_fx2_v2_materializer", materializer_path)
...
def main() -> int:
    ...
    expected_cgroup = Path("/sys/fs/cgroup/user.slice/user-1000.slice/user@1000.service/app.slice/gamma-fx2-transformer-fixture50051-q0-v2")
