#!/usr/bin/env python3
"""Retry the open top-FF1 projection with the exact FF2 transpose."""
...
def require_inputs(experiment: dict[str, Any]) -> None:
    ...
    if not (
        ...
        raise ValueError("exact FF2 transpose antecedents are not satisfied")
...
def main() -> int:
    ...
    parent.FREEZER = ROOT / (
        "tools/nncp_open_profile_top_ff1_bias_gradient_64_q0_retry_v1_materializer.py"
    )
