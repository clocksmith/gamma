...
'''
    ...
    changes['src/predictor.cpp'].append(('#include <vector>','#include <vector>\n#include <iostream>'))
    changes['src/runner.cpp']=[('#include "predictor.h"','#include "predictor.h"\n#include <iostream>')]
    changes['src/predictor.h']=[('#include "mixer/lstm.h"\n','')]
    make=(root/'makefile').read_text()
    changes['makefile']=[(' src/mixer/lstm-layer.h',''),(' src/mixer/lstm.h','')]
