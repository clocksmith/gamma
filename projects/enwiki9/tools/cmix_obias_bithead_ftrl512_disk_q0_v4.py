#!/usr/bin/env python3
"""Build and run one frozen 250KB FTRL512 v4 diagnostic arm."""
...
PROGRAM = ROOT / "programs" / "cmix_obias_bithead_ftrl512_ppm0_q0_v4"
...
def main() -> int:
    ...
    candidate_id = (
        f"cmix_obias_bithead_ftrl512_ppm0_disk_{arm.lower()}_q0_v4"
    )
