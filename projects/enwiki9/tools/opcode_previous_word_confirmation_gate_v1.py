...
CID = 'opcode_previous_word_confirmation1m_q0_v1'
SELF = 'tools/opcode_previous_word_confirmation_gate_v1.py'
CLI = 'tools/opcode_previous_word_confirmation_corpus_v1.py'
INPUTS = 'operations/provenance/opcode_previous_word_confirmation1m_v1_inputs.json'
...
_released = types.FunctionType(release.run_comparison.__code__,
    dict(vars(release), CLI='tools/opcode_previous_word_confirmation_release_corpus_v1.py'),
