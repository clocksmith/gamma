#!/usr/bin/env python3
"""Freeze the manifest-corrected streaming-dot open top-FF2 retry."""
...
FAILED_ID = "nncp_open_profile_top_ff2_gradient_stream_dot_64_q0_retry_v1"
...
FAILED_REVISION = ROOT / (
    ...
    f"{FAILED_ID}/20260816T080438629494Z_057a090c25de.json"
)
FAILED_GUARD = ROOT / f"results/{FAILED_ID}/guard.json"
FAILED_REFLECTION = ROOT / (
    "operations/adaptive/reflections/20260816T080451Z_d5838c6e4e.json"
)
RUNNER = ROOT / (
    "tools/nncp_open_profile_top_ff2_gradient_stream_dot_64_q0_retry_v2.py"
)
...
def main() -> int:
    ...
    additions = [
        base.reference(FAILED_GUARD, "manifest-failure-guard"),
        base.reference(FAILED_REFLECTION, "manifest-failure-reflection"),
    ]
