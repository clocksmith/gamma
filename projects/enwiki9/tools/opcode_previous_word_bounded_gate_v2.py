...
CID = 'opcode_previous_word_confirmation1m_q0_v3'
SELF = 'tools/opcode_previous_word_bounded_gate_v2.py'
CLI = 'tools/opcode_previous_word_bounded_corpus_v1.py'
INPUTS = 'operations/provenance/opcode_previous_word_confirmation1m_v3_inputs.json'
