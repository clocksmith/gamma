#!/usr/bin/env python3
"""Retry the gradient-merge oracle with production rank and axes."""
...
MATERIALIZER = ROOT / (
    "tools/nncp_libnc_bf16_gradient_merge_64_q0_retry_v2_materializer.py"
)
PROGRAM_DESCRIPTOR = PROGRAM / "program.py"
EVALUATOR_SOURCE = PROGRAM / "gradient_merge_rank2.c"
