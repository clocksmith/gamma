#!/usr/bin/env python3
"""One complete-model width-carry comparison using existing phase bounds."""
import argparse
import json
import os
...
PLAN = ROOT / 'operations/provenance/fx2_weight_width_carry_model_v1_plan.json'
...
def run(plan, output, bound_inputs=()):
    ...
    result = dict(schema='gamma.enwiki9.width-carry-model.v1', arms=arms,
