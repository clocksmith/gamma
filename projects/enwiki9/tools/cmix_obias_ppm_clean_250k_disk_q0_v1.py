#!/usr/bin/env python3
"""Build and run the matched clean 250KB disk-backed PPM control."""
...
CANDIDATE_ID = "cmix_obias_ppm_clean_250k_disk_q0_v1"
...
def main() -> int:
    ...
    decision.update(
        {
            "schema": "gamma.enwiki9.cmix-obias-ppm-clean-250k-disk-q0-v1",
            "candidate_id": CANDIDATE_ID,
            "status": "TERMINAL_250KB_INFRASTRUCTURE_DIAGNOSTIC",
            "score_credit_bytes": 0,
            "claim_boundary": (
                "Opening-250KB clean disk-backed comparator only; zero compression "
                "credit and no full-corpus resource claim."
            ),
            "memory_policy": {
                "build_contract_path": None,
                "build_contract_sha256": None,
                "compile_define": None,
                "check_interval_input_bytes": 5000,
            ...
            "decision": {
                ...
                "reason": "Joint comparison against disk-backed PPM0 is required.",
    ...
    print(json.dumps({"event": "ppm_clean_disk_control_terminal"}), flush=True)
    return 0
