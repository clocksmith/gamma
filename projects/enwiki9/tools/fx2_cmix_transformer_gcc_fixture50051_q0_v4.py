...
ID = "fx2_cmix_transformer_gcc_fixture50051_q0_v4"
...
def main() -> int:
    ...
    expected_cgroup = Path("/sys/fs/cgroup/user.slice/user-1000.slice/user@1000.service/app.slice/gamma-fx2-transformer-fixture50051-q0-v4")
