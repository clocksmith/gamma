...
CID = 'opcode_previous_word_confirmation1m_q0_v2'
SELF = 'tools/opcode_previous_word_bounded_gate_v1.py'
CLI = 'tools/opcode_previous_word_bounded_corpus_v1.py'
INPUTS = 'operations/provenance/opcode_previous_word_confirmation1m_v2_inputs.json'
