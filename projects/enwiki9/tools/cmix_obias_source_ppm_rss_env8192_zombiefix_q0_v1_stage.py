...
SCHEMA = "gamma.enwiki9.cmix-obias-source-ppm-rss-env8192-opening1m-stage.zombiefix-q0-v1"
...
def load_base() -> Any:
    if BASE_PATH.is_symlink() or BASE_PATH.resolve(strict=True) != BASE_PATH.absolute() or BASE_PATH.stat().st_size != 21725 or hashlib.sha256(BASE_PATH.read_bytes()).hexdigest() != "e89dbb909526a4f7e9752c233df1f4e8afdd49dc86fd168d0da25796c8d1b939":
        raise RuntimeError("zombiefix telemetry dependency drift before import")
