...
GROUPS = {
    ...
    "native": ["architecture/test_migration.py", "test_fx2_title_memory_v1.py", "test_fx2_envelope.py", "test_causal_relational_v1.py", "test_causal_relational_v2.py", "test_causal_relational_integration.py", "test_donor_coverage_v1.py"],
