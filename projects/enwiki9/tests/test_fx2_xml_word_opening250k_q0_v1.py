...
class Tests(unittest.TestCase):
    ...
    def test_no_activation_or_nonpositive_control_margin_holds(self):
        ...
        tied = runner.decision(dict(P=100, K=100, D=99, S=99), True, 10, True)
        self.assertEqual(tied['scientific_verdict'], 'hold_fixed_realization')
        positive = runner.decision(dict(P=100, K=100, D=98, S=99), True, 10, True)
        ...
        unpaid = runner.decision(dict(P=100, K=100, D=98, S=99), True, 10, False)
        self.assertEqual(unpaid['scientific_verdict'], 'hold_fixed_realization')
