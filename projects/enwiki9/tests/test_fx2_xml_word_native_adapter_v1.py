...
class Tests(unittest.TestCase):
    ...
    def test_initialization_after_pretraining_and_finish_after_coding(self):
        ...
        self.assertIn('GammaXmlBegin(dictionary, gamma_static_frontend ? gamma_literal_header : nullptr, *input_bytes)',text)
        self.assertIn('GammaXmlBegin(dictionary, gamma_static_frontend ? gamma_literal_header : nullptr, 0)',text)
