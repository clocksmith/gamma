...
| active candidate | `opcode_slot_reset_v1` | 250,000 | n/a | active 250,000 byte replay is running; no constructive result is present for this candidate yet | running gate |
| blocker | `n/a` | n/a | n/a | active 250,000 byte deterministic replay has not produced terminal driver and RSS receipts yet | open |
| active gate | `opcode_slot_reset_v1` | 250,000 | n/a | unchanged 250,000 byte RSS-guarded determinism replay; wait for terminal receipts | pending |
