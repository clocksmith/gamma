...
| active candidate | `matched_frontier_reserved_q0_v1` | 1,250,000 | n/a | active 1,250,000 byte replay is running; no constructive result is present for this candidate yet | running gate |
| blocker | `n/a` | n/a | n/a | active 1,250,000 byte deterministic replay has not produced terminal driver and RSS receipts yet | open |
| active gate | `matched_frontier_reserved_q0_v1` | 1,250,000 | n/a | unchanged 1,250,000 byte RSS-guarded determinism replay; wait for terminal receipts | pending |
