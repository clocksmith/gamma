...
- 9.6000000% target score: `96,000,000`
- Calibrated baseline score: `110,181,114`
- Required net gain from calibrated baseline: `14,181,114` bytes
- Required archive slope before program cost: `0.113448912` bits/byte

## Proof Status

- Full-corpus constructive result present: `False`
- 9.6000000% constructive upper bound present: `False`
...
| active candidate | `fx2_matched_train250k_q0_v1` | 250,000 | n/a | active 250,000 byte replay is running; no constructive result is present for this candidate yet | running gate |
| blocker | `n/a` | n/a | n/a | active 250,000 byte deterministic replay has not produced terminal driver and RSS receipts yet | open |
| active gate | `fx2_matched_train250k_q0_v1` | 250,000 | n/a | unchanged 250,000 byte RSS-guarded determinism replay; wait for terminal receipts | pending |
