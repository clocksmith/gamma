...
| active candidate | `opcode_field_confirmation1m_q0_v1` | 1,000,000 | n/a | active 1,000,000 byte replay is running; no constructive result is present for this candidate yet | running gate |
...
| active gate | `opcode_field_confirmation1m_q0_v1` | 1,000,000 | n/a | unchanged 1,000,000 byte RSS-guarded determinism replay; wait for terminal receipts | pending |
