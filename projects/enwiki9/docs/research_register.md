...
2026-09-15: `fx2_residual_features250k_v1` (owner `root_residual_projection`, lenses7/9) prospectively records32 ternary groups of native192 hidden coordinates against the trimmed release P final Q16 counts. One read-only observer build, encode/decode/raw-repeat/untraced phases; exact P archives/coder trajectories and causal feature repeat required. Eight L1-bounded coefficient rows pay512 bytes; exact zero-plane concavity and Q16 rounding bounds screen before fitting. Nine Python tests,65535 identity counts,327675 native wide-integer comparisons,63 cross-language vectors and four source translation units pass. Parent learning remains unchanged; no fitted table or archive improvement yet. [Design](fx2_residual_projection_20260915.md), [plan](../operations/provenance/fx2_residual_features250k_v1_plan.json); no full-corpus credit.
