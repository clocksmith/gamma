...
Candidate `fx2_paid_odds_cost250k_v1`, owner `root_paid_odds`, freezes [paid odds selection](fx2_paid_odds_20260914.md) against unchanged nativeFX2 on exposed raw [0,250000),151210 modeled bytes. Deliberate lenses7/9 combine exact finite selection and paid parent-preserving correction. Seven fixed odds choices in128 causal count/bit-position contexts cost48 transmitted bytes. Exact integer products optimize ideal data plus table cost; this is development fitting, not a finite archive or confirmation. Seven tests compare5488 synthetic joint policies and verify serialization, bounds and alignment. Two independent corpus fits will run only after publication and fresh admission. Historical ratio calibration remains retired; no KDA carry mutation or scalar-MIDAS detour. Shared implementation/package costs and native integration remain unmeasured; g_P/g_S/n1/n2 and full score unknown, objective credit zero.
