...
The [50 research concepts](research_concepts_50.md) now inform Gamma exploration without guaranteeing gains. The [suffix alphabet screen](wrt_suffix_alphabet_20260912.md) preserves the strong native predictor. Candidate `wrt_suffix_alphabet250k_q0_v1` was cancelled before execution after pretraining review; `wrt_suffix_alphabet250k_q0_v2` fixes original-dictionary pretraining and retains P/K 44958 and D 46123 bytes, with complete inverse/repeat checks. Root ENOSPC left S 46400 encode-only and the resource guard nonterminal: g_P=-1165 is preserved, g_S remains unknown. [Failure and partial evidence](../operations/provenance/wrt_suffix_alphabet_v2_partial_20260912.json) stay immutable. Candidate `wrt_suffix_control_completion250k_q0_v1` freezes only missing S inverse/repeat checks on independent storage; it cannot repair the original resource failure. No full-corpus or package credit.
