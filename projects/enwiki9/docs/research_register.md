...
Candidate `fx2_kda_conditional_cost250k_v1`, owner `root_kda_attribution`, freezes [conditional cost attribution](fx2_kda_conditional_cost_20260914.md) over the already measured native P/D/S trajectories on raw [0,250000). Residual-error/complementarity lenses9/12 ask whether global carry loss hides local effects, without reviving or tuning the retired codec. Every piece and seven fixed causal age bins retain ideal gains; favorable selection after observing costs remains hindsight. Exact integer ratio ceilings bound clairvoyant bit selection/convex mixing of these fixed streams only, with a4096-ideal-bit development floor. No finite-archive, changed-feedback or full-corpus bound follows. Five mathematical/alignment/boundary fixtures pass. The held two-subprocess diagnostic binds38 inputs, original P/K byte/state identity and exact WRT reconstruction. Original g_P=-3,g_S=11 are unchanged; no new archive, package or objective credit is claimed. Full score unknown; forecast109389323, target90000000, debt+19389323.
