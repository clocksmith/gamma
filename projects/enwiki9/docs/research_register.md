...
conditional 554-byte source charge. [Reset-only successor](../operations/adaptive/experiments/opcode_slot_reset_v1.json): ten synthetic tests pass; corpus gate awaits publication/admission.
