...
2026-09-14: `fx2_expert_mix_opening250k_v1` freezes one native posterior mixture from PPMd/neural/FXCM disagreements after the paid final-odds table missed. Owner `root_expert_mix`, lenses8/9, exposed opening250KB; P/K/D/S with eight-bit-delayed experts, parent trajectory invariant, exact inverses/repeats and introduced-state checks. Synthetic identity/posterior tests pass; held pending publication and admission. [Contract](../operations/adaptive/experiments/fx2_expert_mix_opening250k_v1.json), [design](fx2_expert_mix_20260914.md). No novelty, archive gain or full-corpus credit yet.
