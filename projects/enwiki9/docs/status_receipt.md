...
- Generated at UTC: `2026-07-27T22:38:22+00:00`
...
- Latest sampled single RSS KiB: `9,603,524`
- Tightest binary single-process margin KiB: `878,396`
- Tightest decimal single-process margin KiB: `158,261`
- Latest binary single-process margin KiB: `882,236`
- Latest decimal single-process margin KiB: `162,101`
...
- RSS guard JSON modified UTC: `2026-07-27T22:38:20+00:00`
- RSS guard JSON SHA-256: `64693ab6699975d10b3800cbe2c8169482bd9276c0cc39abdebd4f3b86f142ed`
- RSS samples: `8,645`
- Max sampled single RSS KiB: `9,607,364`
- Max sampled tree RSS KiB: `9,644,424`
- Single-process RSS margin KiB: `878,396`
- Single-process decimal `10GB` margin KiB: `158,261`
- Tree RSS margin KiB: `841,336`
- Tree decimal `10GB` margin KiB: `121,201`
- Latest sampled single RSS KiB: `9,603,524`
- Latest sampled tree RSS KiB: `9,644,424`
- Latest sampled single-process margin KiB: `882,236`
- Latest sampled single-process decimal `10GB` margin KiB: `162,101`
- Latest sampled tree margin KiB: `841,336`
- Latest sampled tree decimal `10GB` margin KiB: `121,201`
...
- Audit return code: `0`
- Program directories: `586`
- Registered programs: `242`
- Untracked nonignored entries: `10`
- Modified tracked entries: `3`
- Candidate statuses: `active=22, blocked_dependency=31, candidate=18, measured_negative=89, retired=425, track_source_before_evolution=1`
...
| `native_cmix` | 332,698 | 265,690 | 9,603,524 | `/tmp/cmix21-mmap-bin-56pc3n75 -t /tmp/cmix21-mmap-dict-zmmck3q4 /tmp/tmpvcizoafb/in /tmp/tmpvcizoafb/out` |
...
| `process` | 378,881 | 377,794 | 1,792 | `sleep 30` |

## Active Candidate Recent Artifacts

| Path | Bytes | Modified UTC |
|---|---:|---|
| `projects/enwiki9/results/cmix21_text_mmap_paq5_ppmd20352k_fxcmassoc10_fxcmidx13div2_fxcmrcm20_ppmdguard2_rcm32_bufthirtysecond_minmaps_v1/fxcmassoc10_10000000_exact_rss_guard.json` | 1,392 | `2026-07-27T22:38:20+00:00` |
...
- Max cmix PID: `332698`
- Active cmix mode: `text_compress`
- Max cmix RSS KiB: `9,603,524`
- Active process tree RSS KiB: `9,667,336`
- Local binary `10GiB` guard KiB: `10,485,760`
- Decimal `10GB` guard KiB: `9,765,625`
- Single-process binary margin KiB: `882,236`
- Single-process decimal margin KiB: `162,101`
- Active process tree margin KiB (binary): `818,424`
- Active process tree decimal margin KiB: `98,289`
