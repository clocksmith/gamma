...
- Generated at UTC: `2026-07-27T22:54:35+00:00`
...
- Latest sampled single RSS KiB: `9,604,036`
- Tightest binary single-process margin KiB: `878,396`
- Tightest decimal single-process margin KiB: `158,261`
- Latest binary single-process margin KiB: `881,724`
- Latest decimal single-process margin KiB: `161,589`
...
- RSS guard status: `running`
- RSS guard JSON bytes: `1,391`
- RSS guard JSON modified UTC: `2026-07-27T22:54:35+00:00`
- RSS guard JSON SHA-256: `5ead6f9ed9bbf739c2cd2e446b8cfa00ac2d0f2707d8f22f1211370ba29b3301`
- RSS samples: `8,840`
- Max sampled single RSS KiB: `9,607,364`
- Max sampled tree RSS KiB: `9,644,936`
- Single-process RSS margin KiB: `878,396`
- Single-process decimal `10GB` margin KiB: `158,261`
- Tree RSS margin KiB: `840,824`
- Tree decimal `10GB` margin KiB: `120,689`
- Latest sampled single RSS KiB: `9,604,036`
- Latest sampled tree RSS KiB: `9,644,936`
- Latest sampled single-process margin KiB: `881,724`
- Latest sampled single-process decimal `10GB` margin KiB: `161,589`
- Latest sampled tree margin KiB: `840,824`
- Latest sampled tree decimal `10GB` margin KiB: `120,689`
...
- Candidate statuses: `active=22, blocked_dependency=31, candidate=18, measured_negative=89, retired=426`
...
| `native_cmix` | 332,698 | 265,690 | 9,604,036 | `/tmp/cmix21-mmap-bin-56pc3n75 -t /tmp/cmix21-mmap-dict-zmmck3q4 /tmp/tmpvcizoafb/in /tmp/tmpvcizoafb/out` |
...
| `process` | 381,783 | 377,794 | 1,792 | `sleep 30` |

## Active Candidate Recent Artifacts

| Path | Bytes | Modified UTC |
|---|---:|---|
| `projects/enwiki9/results/cmix21_text_mmap_paq5_ppmd20352k_fxcmassoc10_fxcmidx13div2_fxcmrcm20_ppmdguard2_rcm32_bufthirtysecond_minmaps_v1/fxcmassoc10_10000000_exact_rss_guard.json` | 1,391 | `2026-07-27T22:54:35+00:00` |
...
- Max cmix PID: `332698`
- Active cmix mode: `text_compress`
- Max cmix RSS KiB: `9,604,036`
- Active process tree RSS KiB: `9,667,848`
- Local binary `10GiB` guard KiB: `10,485,760`
- Decimal `10GB` guard KiB: `9,765,625`
- Single-process binary margin KiB: `881,724`
- Single-process decimal margin KiB: `161,589`
- Active process tree margin KiB (binary): `817,912`
- Active process tree decimal margin KiB: `97,777`
