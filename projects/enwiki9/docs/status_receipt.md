...
- Generated at UTC: `2026-08-24T13:35:07+00:00`
...
- Latest sampled single RSS KiB: `8,612,428`
- Tightest binary single-process margin KiB: `1,507,728`
- Tightest decimal single-process margin KiB: `787,593`
- Latest binary single-process margin KiB: `1,873,332`
- Latest decimal single-process margin KiB: `1,153,197`
...
- Active scorer observed: `true`
- Codec progress: `22.70%`
- Reported payload bytes: `29,943,588`
- Progress log: `projects/enwiki9/scratch/cmix_filebacked_fxcm_full_a_qm8_v1/encode/progress.log`
- Progress log modified UTC: `2026-08-24T13:34:42+00:00`
- Live gate: `true`
...
- RSS guard JSON modified UTC: `2026-08-24T13:35:06+00:00`
- RSS guard JSON SHA-256: `8fd6b633e80fb282e2b4ebd8332ef5e5850028e9a2844341989874898061ebee`
- RSS samples: `109,122`
- Max sampled single RSS KiB: `8,978,032`
...
- Latest sampled single RSS KiB: `8,612,428`
- Latest sampled tree RSS KiB: `8,631,068`
- Latest sampled single-process margin KiB: `1,873,332`
- Latest sampled single-process decimal `10GB` margin KiB: `1,153,197`
- Latest sampled tree margin KiB: `1,854,692`
- Latest sampled tree decimal `10GB` margin KiB: `1,134,557`
- Cgroup memory peak bytes: `9,002,086,400`
- Latest cgroup current bytes: `8,999,239,680`
- Cgroup event deltas: `{'high': 305544, 'low': 0, 'max': 0, 'oom': 0, 'oom_group_kill': 0, 'oom_kill': 0, 'sock_throttled': 0}`
...
| `native_cmix` | 4,136,098 | 4,136,006 | 8,615,916 | `./cmix -e /home/x/enwiki9-quarantine/mattmahoney-20260711/enwik9 out.cmix` |

## Active Candidate Recent Artifacts

| Path | Bytes | Modified UTC |
|---|---:|---|
| `projects/enwiki9/results/cmix_filebacked_fxcm_full_a_qm8_v1/encode/guard.json` | 57,641 | `2026-08-24T13:36:21+00:00` |
| `projects/enwiki9/results/cmix_filebacked_fxcm_full_a_qm8_v1/encode/encode.codec.stderr` | 567,310 | `2026-08-24T13:36:15+00:00` |
...
- Active cmix mode: `encode`
- Max cmix RSS KiB: `8,615,916`
- Active process tree RSS KiB: `8,796,808`
- Local binary `10GiB` guard KiB: `10,485,760`
- Decimal `10GB` guard KiB: `9,765,625`
- Single-process binary margin KiB: `1,869,844`
- Single-process decimal margin KiB: `1,149,709`
- Active process tree margin KiB (binary): `1,688,952`
- Active process tree decimal margin KiB: `968,817`
...
- Process read bytes: `474,292,551,680`
- Process write bytes: `31,824,898,244,608`
