...
- Generated at UTC: `2026-08-15T17:54:51+00:00`
...
- Candidate: `delta_midas_named_midpoint_gradient_65536_q2_v1`
- Scope bytes: `65,536`
...
- Max sampled single RSS KiB: `6,204,000`
- Latest sampled single RSS KiB: `6,204,000`
- Tightest binary single-process margin KiB: `4,281,760`
- Tightest decimal single-process margin KiB: `3,561,625`
- Latest binary single-process margin KiB: `4,281,760`
- Latest decimal single-process margin KiB: `3,561,625`
...
- Candidate: `delta_midas_named_midpoint_gradient_65536_q2_v1`
- Scope bytes: `65,536`
- Driver result JSON: `projects/enwiki9/results/delta_midas_named_midpoint_gradient_65536_q2_v1/decision.json`
- Driver result present: `false`
- RSS guard JSON: `/home/x/deco/gamma/projects/enwiki9/results/delta_midas_named_midpoint_gradient_65536_q2_v1/guard.json`
...
- RSS guard status: `running`
- RSS guard JSON bytes: `7,091`
- RSS guard JSON modified UTC: `2026-08-15T17:54:48+00:00`
- RSS guard JSON SHA-256: `2456ae4ef68cfb1399dd53d1f066977440d989cc912d88b3cc325c639a3208a4`
- RSS samples: `303`
- Max sampled single RSS KiB: `6,204,000`
- Max sampled tree RSS KiB: `6,250,576`
- Single-process RSS margin KiB: `4,281,760`
- Single-process decimal `10GB` margin KiB: `3,561,625`
- Tree RSS margin KiB: `4,235,184`
- Tree decimal `10GB` margin KiB: `3,515,049`
- Latest sampled single RSS KiB: `6,204,000`
- Latest sampled tree RSS KiB: `6,250,576`
- Latest sampled single-process margin KiB: `4,281,760`
- Latest sampled single-process decimal `10GB` margin KiB: `3,561,625`
- Latest sampled tree margin KiB: `4,235,184`
- Latest sampled tree decimal `10GB` margin KiB: `3,515,049`
...
- Expected candidate: `delta_midas_named_midpoint_gradient_65536_q2_v1`
...
- Expected active candidate: `delta_midas_named_midpoint_gradient_65536_q2_v1`
...
- Audit return code: `0`
- Program directories: `781`
- Registered programs: `339`
- Untracked nonignored entries: `0`
- Modified tracked entries: `1`
- Candidate statuses: `active=18, blocked_dependency=33, candidate=86, measured_negative=100, retired=544`

## Active Runner Process Table

| Role | PID | PPID | RSS KiB | Command |
|---|---:|---:|---:|---|
| `process` | 3,437,956 | 130,532 | 35,776 | `python3 projects/enwiki9/tools/enwiki9_lab.py run --candidate delta_midas_named_midpoint_gradient_65536_q2_v1 --max-workers 1` |
| `rss_guard` | 3,438,091 | 3,437,956 | 31,592 | `/usr/bin/python3 /home/x/deco/gamma/projects/enwiki9/tools/run_with_rss_guard.py --limit-kib 9765625 --limit-mode tree --official-decimal-limit-kib...` |
| `process` | 3,438,116 | 3,438,091 | 46,576 | `python3 tools/nncp_delta_midas_named_midpoint_gradient_q2.py --experiment operations/adaptive/experiments/delta_midas_named_midpoint_gradient_65536...` |
| `process` | 3,438,424 | 3,438,116 | 6,204,000 | `/home/x/deco/gamma/projects/enwiki9/results/delta_midas_named_midpoint_gradient_65536_q2_v1/scratch/source/nncp -q -T 4 --profile enwik9 --n_symb 1...` |

## Active Candidate Recent Artifacts

| Path | Bytes | Modified UTC |
|---|---:|---|
| `projects/enwiki9/results/delta_midas_named_midpoint_gradient_65536_q2_v1/guard.json` | 7,091 | `2026-08-15T17:54:48+00:00` |
| `projects/enwiki9/results/delta_midas_named_midpoint_gradient_65536_q2_v1/F_named_gradient_1.nncp` | 49,152 | `2026-08-15T17:29:38+00:00` |
...
- Active process tree RSS KiB: `6,317,944`
- Local binary `10GiB` guard KiB: `10,485,760`
- Decimal `10GB` guard KiB: `9,765,625`
- Single-process binary margin KiB: `n/a`
- Single-process decimal margin KiB: `n/a`
- Active process tree margin KiB (binary): `4,167,816`
- Active process tree decimal margin KiB: `3,447,681`
