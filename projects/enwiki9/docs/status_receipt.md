...
- Generated at UTC: `2026-09-09T02:33:50+00:00`
...
- Candidate: `opcode_literal_sse250k_q0_v1`
- Scope bytes: `250,000`
- Scope symbols: `n/a`
- Scope unit: `raw byte`
...
- Roundtrip arm: `n/a`
- Coordinator PID: `n/a`
- Driver result JSON: `projects/enwiki9/results/opcode_literal_sse250k_q0_v1/decision.json`
- Driver result present: `false`
...
- Expected candidate: `opcode_literal_sse250k_q0_v1`
...
- Expected active candidate: `opcode_literal_sse250k_q0_v1`
...
- Inventory generated: `2026-09-09T01:35:56+00:00`
- Snapshot identity is verified; inventory inputs were not rescanned. This is not live occupancy or launch authority.
- Program directories: `1,014`
- Registered programs: `553`
- Untracked nonignored entries: `1`
- Modified tracked entries: `1`
- Candidate statuses: `active=18, blocked_dependency=77, candidate=247, measured_negative=100, retired=572`
...
|---|---:|---:|---:|---|
| `process` | 434,232 | 2,643,307 | 41,768 | `python3 tools/enwiki9_lab.py run --candidate opcode_literal_sse250k_q0_v1 --max-workers 1 --min-free-mib 32768 --max-load 16 --poll-seconds 2` |
| `resource_guard` | 434,438 | 434,232 | 32,960 | `/usr/bin/python3 /home/x/deco/gamma/projects/enwiki9/tools/run_with_resource_guard_v3.py --limit-kib 4194304 --official-decimal-limit-kib 4194304 -...` |
| `process` | 434,463 | 434,438 | 24,160 | `/usr/bin/python3 /home/x/deco/gamma/projects/enwiki9/tools/opcode_literal_sse_gate_v1.py` |
| `process` | 445,285 | 434,463 | 210,356 | `/usr/bin/python3 /home/x/deco/gamma/projects/enwiki9/tools/opcode_literal_sse_corpus_v1.py decode /home/x/deco/gamma/projects/enwiki9/results/opcod...` |

## Active Candidate Recent Artifacts

| Path | Bytes | Modified UTC |
|---|---:|---|
| `projects/enwiki9/results/opcode_literal_sse250k_q0_v1/P-decode.stderr` | 0 | `2026-09-09T02:33:40+00:00` |
| `projects/enwiki9/results/opcode_literal_sse250k_q0_v1/P-decode.stdout` | 0 | `2026-09-09T02:33:40+00:00` |
| `projects/enwiki9/results/opcode_literal_sse250k_q0_v1/P-encode.execution.json` | 813 | `2026-09-09T02:33:40+00:00` |
| `projects/enwiki9/results/opcode_literal_sse250k_q0_v1/P-encode.stdout` | 123 | `2026-09-09T02:33:40+00:00` |
| `projects/enwiki9/results/opcode_literal_sse250k_q0_v1/P-encode.audit.json` | 25,270 | `2026-09-09T02:33:40+00:00` |
| `projects/enwiki9/results/opcode_literal_sse250k_q0_v1/P.arc` | 67,658 | `2026-09-09T02:33:40+00:00` |
| `projects/enwiki9/results/opcode_literal_sse250k_q0_v1/P-encode.stderr` | 0 | `2026-09-09T02:32:41+00:00` |
...
- Active process tree RSS KiB: `309,244`
- Local binary `10GiB` guard KiB: `10,485,760`
- Decimal `10GB` guard KiB: `9,765,625`
- Single-process binary margin KiB: `n/a`
- Single-process decimal margin KiB: `n/a`
- Active process tree margin KiB (binary): `10,176,516`
- Active process tree decimal margin KiB: `9,456,381`
