...
- Generated at UTC: `2026-09-09T00:12:36+00:00`
...
- Candidate: `opcode_event_parse250k_q0_v1`
- Scope bytes: `250,000`
- Scope symbols: `n/a`
- Scope unit: `raw byte`
...
- Roundtrip arm: `n/a`
- Coordinator PID: `n/a`
- Driver result JSON: `projects/enwiki9/results/opcode_event_parse250k_q0_v1/decision.json`
- Driver result present: `false`
...
- Expected candidate: `opcode_event_parse250k_q0_v1`
...
- Expected active candidate: `opcode_event_parse250k_q0_v1`
...
- Inventory generated: `2026-09-08T23:38:58+00:00`
- Snapshot identity is verified; inventory inputs were not rescanned. This is not live occupancy or launch authority.
- Program directories: `1,011`
- Registered programs: `550`
- Untracked nonignored entries: `1`
- Modified tracked entries: `1`
- Candidate statuses: `active=18, blocked_dependency=75, candidate=247, measured_negative=100, retired=571`
...
|---|---:|---:|---:|---|
| `process` | 2,980,444 | 2,643,307 | 41,680 | `python3 tools/enwiki9_lab.py run --candidate opcode_event_parse250k_q0_v1 --max-workers 1` |
| `resource_guard` | 2,980,631 | 2,980,444 | 33,124 | `/usr/bin/python3 /home/x/deco/gamma/projects/enwiki9/tools/run_with_resource_guard_v3.py --limit-kib 4194304 --official-decimal-limit-kib 4194304 -...` |
| `process` | 2,980,648 | 2,980,631 | 24,428 | `/usr/bin/python3 /home/x/deco/gamma/projects/enwiki9/tools/opcode_event_parse_gate_v1.py` |
| `process` | 3,015,610 | 2,980,648 | 365,748 | `/usr/bin/python3 /home/x/deco/gamma/projects/enwiki9/tools/opcode_event_parse_corpus_v1.py encode /home/x/deco/gamma/projects/enwiki9/operations/ev...` |

## Active Candidate Recent Artifacts

| Path | Bytes | Modified UTC |
|---|---:|---|
| `projects/enwiki9/results/opcode_event_parse250k_q0_v1/K-encode.stdout` | 0 | `2026-09-09T00:12:02+00:00` |
| `projects/enwiki9/results/opcode_event_parse250k_q0_v1/K-encode.stderr` | 0 | `2026-09-09T00:12:02+00:00` |
| `projects/enwiki9/results/opcode_event_parse250k_q0_v1/P-repeat.execution.json` | 823 | `2026-09-09T00:12:02+00:00` |
| `projects/enwiki9/results/opcode_event_parse250k_q0_v1/P-repeat.stdout` | 129 | `2026-09-09T00:12:02+00:00` |
| `projects/enwiki9/results/opcode_event_parse250k_q0_v1/P-repeat.audit.json` | 24,889 | `2026-09-09T00:12:02+00:00` |
| `projects/enwiki9/results/opcode_event_parse250k_q0_v1/P.repeat.arc` | 67,658 | `2026-09-09T00:12:02+00:00` |
| `projects/enwiki9/results/opcode_event_parse250k_q0_v1/P-repeat.stderr` | 0 | `2026-09-09T00:11:00+00:00` |
| `projects/enwiki9/results/opcode_event_parse250k_q0_v1/P-decode.execution.json` | 807 | `2026-09-09T00:11:00+00:00` |
| `projects/enwiki9/results/opcode_event_parse250k_q0_v1/P-decode.audit.json` | 24,889 | `2026-09-09T00:11:00+00:00` |
| `projects/enwiki9/results/opcode_event_parse250k_q0_v1/P-decode.stdout` | 125 | `2026-09-09T00:11:00+00:00` |
| `projects/enwiki9/results/opcode_event_parse250k_q0_v1/P.raw` | 250,000 | `2026-09-09T00:11:00+00:00` |
| `projects/enwiki9/results/opcode_event_parse250k_q0_v1/P-decode.stderr` | 0 | `2026-09-09T00:10:29+00:00` |
...
- Active process tree RSS KiB: `464,980`
- Local binary `10GiB` guard KiB: `10,485,760`
- Decimal `10GB` guard KiB: `9,765,625`
- Single-process binary margin KiB: `n/a`
- Single-process decimal margin KiB: `n/a`
- Active process tree margin KiB (binary): `10,020,780`
- Active process tree decimal margin KiB: `9,300,645`
