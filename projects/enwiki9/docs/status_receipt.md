...
- Generated at UTC: `2026-08-24T12:55:46+00:00`
...
- Latest sampled single RSS KiB: `8,410,380`
- Tightest binary single-process margin KiB: `1,507,728`
- Tightest decimal single-process margin KiB: `787,593`
- Latest binary single-process margin KiB: `2,075,380`
- Latest decimal single-process margin KiB: `1,355,245`
...
- Active scorer observed: `true`
- Codec progress: `21.94%`
- Reported payload bytes: `28,865,769`
- Progress log: `projects/enwiki9/scratch/cmix_filebacked_fxcm_full_a_qm8_v1/encode/progress.log`
- Progress log modified UTC: `2026-08-24T12:55:15+00:00`
- Live gate: `true`
...
- RSS guard JSON modified UTC: `2026-08-24T12:55:46+00:00`
- RSS guard JSON SHA-256: `654d640e71afe89ba85b692614450a6ab1ca51c263516d4bae50709518acacb6`
- RSS samples: `104,563`
- Max sampled single RSS KiB: `8,978,032`
...
- Latest sampled single RSS KiB: `8,410,380`
- Latest sampled tree RSS KiB: `8,429,020`
- Latest sampled single-process margin KiB: `2,075,380`
- Latest sampled single-process decimal `10GB` margin KiB: `1,355,245`
- Latest sampled tree margin KiB: `2,056,740`
- Latest sampled tree decimal `10GB` margin KiB: `1,336,605`
- Cgroup memory peak bytes: `9,002,086,400`
- Latest cgroup current bytes: `8,999,567,360`
- Cgroup event deltas: `{'high': 286530, 'low': 0, 'max': 0, 'oom': 0, 'oom_group_kill': 0, 'oom_kill': 0, 'sock_throttled': 0}`
...
| `resource_guard` | 4,135,989 | 4,135,986 | 67,180 | `/usr/bin/python3 /home/x/deco/gamma/projects/enwiki9/tools/run_with_resource_guard_v3.py --limit-kib 9765625 --limit-mode tree --official-decimal-l...` |
...
| `native_cmix` | 4,136,098 | 4,136,006 | 8,486,488 | `./cmix -e /home/x/enwiki9-quarantine/mattmahoney-20260711/enwik9 out.cmix` |

## Active Candidate Recent Artifacts

| Path | Bytes | Modified UTC |
|---|---:|---|
| `projects/enwiki9/results/cmix_filebacked_fxcm_full_a_qm8_v1/encode/guard.json` | 57,639 | `2026-08-24T12:57:01+00:00` |
| `projects/enwiki9/results/cmix_filebacked_fxcm_full_a_qm8_v1/encode/encode.codec.stderr` | 566,018 | `2026-08-24T12:56:47+00:00` |
...
- Active cmix mode: `encode`
- Max cmix RSS KiB: `8,486,488`
- Active process tree RSS KiB: `8,667,200`
- Local binary `10GiB` guard KiB: `10,485,760`
- Decimal `10GB` guard KiB: `9,765,625`
- Single-process binary margin KiB: `1,999,272`
- Single-process decimal margin KiB: `1,279,137`
- Active process tree margin KiB (binary): `1,818,560`
- Active process tree decimal margin KiB: `1,098,425`
...
- Process read bytes: `444,683,350,016`
- Process write bytes: `30,662,598,754,304`
