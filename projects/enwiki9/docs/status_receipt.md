...
- Generated at UTC: `2026-07-27T18:54:35+00:00`
...
- Latest sampled single RSS KiB: `9,604,584`
- Tightest binary single-process margin KiB: `878,396`
- Tightest decimal single-process margin KiB: `158,261`
- Latest binary single-process margin KiB: `881,176`
- Latest decimal single-process margin KiB: `161,041`
...
- RSS guard JSON modified UTC: `2026-07-27T18:54:32+00:00`
- RSS guard JSON SHA-256: `344eca56915c49d85863a918d4946883aebf089e6825a7c3eb0c2927d0117454`
- RSS samples: `5,960`
- Max sampled single RSS KiB: `9,607,364`
...
- Latest sampled single RSS KiB: `9,604,584`
- Latest sampled tree RSS KiB: `9,635,756`
- Latest sampled single-process margin KiB: `881,176`
- Latest sampled single-process decimal `10GB` margin KiB: `161,041`
- Latest sampled tree margin KiB: `850,004`
- Latest sampled tree decimal `10GB` margin KiB: `129,869`
...
- Audit return code: `0`
- Program directories: `563`
- Registered programs: `231`
- Untracked nonignored entries: `12`
- Modified tracked entries: `2`
- Candidate statuses: `active=22, blocked_dependency=31, candidate=7, measured_negative=89, retired=413, track_source_before_evolution=1`
...
| `native_cmix` | 302,319 | 265,690 | 9,604,584 | `/tmp/cmix21-mmap-bin-56pc3n75 -d /tmp/cmix21-mmap-dict-zmmck3q4 /tmp/tmp2q4qrc6n/in /tmp/tmp2q4qrc6n/out` |
...
|---|---:|---|
| `projects/enwiki9/results/cmix21_text_mmap_paq5_ppmd20352k_fxcmassoc10_fxcmidx13div2_fxcmrcm20_ppmdguard2_rcm32_bufthirtysecond_minmaps_v1/fxcmassoc10_10000000_exact_rss_guard.json` | 1,392 | `2026-07-27T18:54:32+00:00` |
...
- Max cmix PID: `302319`
- Active cmix mode: `decode`
- Max cmix RSS KiB: `9,604,584`
- Active process tree RSS KiB: `9,653,292`
- Local binary `10GiB` guard KiB: `10,485,760`
- Decimal `10GB` guard KiB: `9,765,625`
- Single-process binary margin KiB: `881,176`
- Single-process decimal margin KiB: `161,041`
- Active process tree margin KiB (binary): `832,468`
- Active process tree decimal margin KiB: `112,333`
...
- Temp output staging bytes: `5,496,832`
- Temp input modified UTC: `2026-07-27T15:00:33+00:00`
- Temp output modified UTC: `n/a`
- Temp output staging modified UTC: `2026-07-27T18:54:25+00:00`
- Process read bytes: `397,312`
- Process write bytes: `5,496,832`
- Decode scope progress: `5,496,832` / `10,000,000` bytes (`54.968%`)
- Decode remaining scope bytes: `4,503,168`
