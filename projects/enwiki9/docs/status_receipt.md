...
- Generated at UTC: `2026-07-27T23:24:27+00:00`
...
- Latest sampled single RSS KiB: `9,605,188`
- Tightest binary single-process margin KiB: `878,396`
- Tightest decimal single-process margin KiB: `158,261`
- Latest binary single-process margin KiB: `880,572`
- Latest decimal single-process margin KiB: `160,437`
...
- RSS guard JSON modified UTC: `2026-07-27T23:24:25+00:00`
- RSS guard JSON SHA-256: `238e3d87efbec6bfe9747ba1432c3294ad41a66df2471f2b8bc8a75b0464d01e`
- RSS samples: `9,198`
- Max sampled single RSS KiB: `9,607,364`
- Max sampled tree RSS KiB: `9,646,088`
- Single-process RSS margin KiB: `878,396`
- Single-process decimal `10GB` margin KiB: `158,261`
- Tree RSS margin KiB: `839,672`
- Tree decimal `10GB` margin KiB: `119,537`
- Latest sampled single RSS KiB: `9,605,188`
- Latest sampled tree RSS KiB: `9,646,088`
- Latest sampled single-process margin KiB: `880,572`
- Latest sampled single-process decimal `10GB` margin KiB: `160,437`
- Latest sampled tree margin KiB: `839,672`
- Latest sampled tree decimal `10GB` margin KiB: `119,537`
...
- Candidate statuses: `active=22, blocked_dependency=31, candidate=18, measured_negative=89, retired=426, track_source_before_evolution=1`
...
| `native_cmix` | 332,698 | 265,690 | 9,605,188 | `/tmp/cmix21-mmap-bin-56pc3n75 -t /tmp/cmix21-mmap-dict-zmmck3q4 /tmp/tmpvcizoafb/in /tmp/tmpvcizoafb/out` |
...
| `process` | 388,820 | 377,794 | 1,792 | `sleep 30` |

## Active Candidate Recent Artifacts

| Path | Bytes | Modified UTC |
|---|---:|---|
| `projects/enwiki9/results/cmix21_text_mmap_paq5_ppmd20352k_fxcmassoc10_fxcmidx13div2_fxcmrcm20_ppmdguard2_rcm32_bufthirtysecond_minmaps_v1/fxcmassoc10_10000000_exact_rss_guard.json` | 1,392 | `2026-07-27T23:24:25+00:00` |
...
- Max cmix PID: `332698`
- Active cmix mode: `text_compress`
- Max cmix RSS KiB: `9,605,188`
- Active process tree RSS KiB: `9,669,000`
- Local binary `10GiB` guard KiB: `10,485,760`
- Decimal `10GB` guard KiB: `9,765,625`
- Single-process binary margin KiB: `880,572`
- Single-process decimal margin KiB: `160,437`
- Active process tree margin KiB (binary): `816,760`
- Active process tree decimal margin KiB: `96,625`
