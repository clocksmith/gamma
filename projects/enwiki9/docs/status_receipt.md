...
- Generated at UTC: `2026-09-08T16:28:52+00:00`
...
- Roundtrip arm: `n/a`
- Coordinator PID: `n/a`
- Driver result JSON: `projects/enwiki9/results/opcode_wiki_slot_v1/decision.json`
- Driver result present: `false`
...
- Expected candidate: `opcode_wiki_slot_v1`
...
- Expected active candidate: `opcode_wiki_slot_v1`
...
- Inventory generated: `2026-09-08T16:28:48+00:00`
- Snapshot identity is verified; inventory inputs were not rescanned. This is not live occupancy or launch authority.
- Program directories: `998`
- Registered programs: `537`
- Untracked nonignored entries: `0`
- Modified tracked entries: `3`
- Candidate statuses: `active=18, blocked_dependency=69, candidate=243, measured_negative=100, retired=568`
...
|---|---:|---:|---:|---|
| `process` | 1,508,746 | 2,643,307 | 41,916 | `python3 tools/enwiki9_lab.py run --candidate opcode_wiki_slot_v1 --max-workers 1` |
| `resource_guard` | 1,508,944 | 1,508,746 | 33,696 | `/usr/bin/python3 /home/x/deco/gamma/projects/enwiki9/tools/run_with_resource_guard_v3.py --limit-kib 4194304 --official-decimal-limit-kib 4194304 -...` |
| `process` | 1,508,962 | 1,508,944 | 24,876 | `/usr/bin/python3 /home/x/deco/gamma/projects/enwiki9/tools/opcode_wiki_slot_gate_v1.py` |
| `process` | 1,548,245 | 1,508,962 | 403,668 | `/usr/bin/python3 /home/x/deco/gamma/projects/enwiki9/tools/opcode_wiki_slot_observe_v1.py decode /home/x/deco/gamma/projects/enwiki9/results/opcode...` |

## Active Candidate Recent Artifacts

| Path | Bytes | Modified UTC |
|---|---:|---|
| `projects/enwiki9/results/opcode_wiki_slot_v1/K-decode.stdout` | 0 | `2026-09-08T16:28:14+00:00` |
| `projects/enwiki9/results/opcode_wiki_slot_v1/K-decode.stderr` | 0 | `2026-09-08T16:28:14+00:00` |
| `projects/enwiki9/results/opcode_wiki_slot_v1/K-encode.execution.json` | 880 | `2026-09-08T16:28:14+00:00` |
| `projects/enwiki9/results/opcode_wiki_slot_v1/K-encode.stdout` | 122 | `2026-09-08T16:28:14+00:00` |
| `projects/enwiki9/results/opcode_wiki_slot_v1/K-encode.audit.json` | 32,229 | `2026-09-08T16:28:14+00:00` |
| `projects/enwiki9/results/opcode_wiki_slot_v1/K.arc` | 67,658 | `2026-09-08T16:28:14+00:00` |
| `projects/enwiki9/results/opcode_wiki_slot_v1/K-encode.stderr` | 0 | `2026-09-08T16:27:00+00:00` |
| `projects/enwiki9/results/opcode_wiki_slot_v1/P-repeat.execution.json` | 865 | `2026-09-08T16:27:00+00:00` |
| `projects/enwiki9/results/opcode_wiki_slot_v1/P-repeat.stdout` | 123 | `2026-09-08T16:27:00+00:00` |
| `projects/enwiki9/results/opcode_wiki_slot_v1/P-repeat.audit.json` | 31,487 | `2026-09-08T16:27:00+00:00` |
| `projects/enwiki9/results/opcode_wiki_slot_v1/P.repeat.arc` | 67,658 | `2026-09-08T16:27:00+00:00` |
| `projects/enwiki9/results/opcode_wiki_slot_v1/P-repeat.stderr` | 0 | `2026-09-08T16:26:06+00:00` |
...
- Active process tree RSS KiB: `504,156`
- Local binary `10GiB` guard KiB: `10,485,760`
- Decimal `10GB` guard KiB: `9,765,625`
- Single-process binary margin KiB: `n/a`
- Single-process decimal margin KiB: `n/a`
- Active process tree margin KiB (binary): `9,981,604`
- Active process tree decimal margin KiB: `9,261,469`
