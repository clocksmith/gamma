...
- Generated at UTC: `2026-09-09T00:34:09+00:00`
...
- Candidate: `opcode_event_parse_validation250k_q0_v1`
- Scope bytes: `250,000`
- Scope symbols: `n/a`
- Scope unit: `raw byte`
...
- Roundtrip arm: `n/a`
- Coordinator PID: `n/a`
- Driver result JSON: `projects/enwiki9/results/opcode_event_parse_validation250k_q0_v1/decision.json`
- Driver result present: `false`
...
- Expected candidate: `opcode_event_parse_validation250k_q0_v1`
...
- Expected active candidate: `opcode_event_parse_validation250k_q0_v1`
...
- Inventory generated: `2026-09-09T00:19:39+00:00`
- Snapshot identity is verified; inventory inputs were not rescanned. This is not live occupancy or launch authority.
- Program directories: `1,012`
- Registered programs: `551`
- Untracked nonignored entries: `1`
- Modified tracked entries: `1`
- Candidate statuses: `active=18, blocked_dependency=75, candidate=247, measured_negative=100, retired=572`
...
|---|---:|---:|---:|---|
| `process` | 3,311,240 | 2,643,307 | 41,660 | `python3 tools/enwiki9_lab.py run --candidate opcode_event_parse_validation250k_q0_v1 --max-workers 1` |
| `resource_guard` | 3,311,413 | 3,311,240 | 32,732 | `/usr/bin/python3 /home/x/deco/gamma/projects/enwiki9/tools/run_with_resource_guard_v3.py --limit-kib 4194304 --official-decimal-limit-kib 4194304 -...` |
| `process` | 3,311,426 | 3,311,413 | 24,216 | `/usr/bin/python3 /home/x/deco/gamma/projects/enwiki9/tools/opcode_event_parse_validation_gate_v1.py` |
| `process` | 3,311,435 | 3,311,426 | 411,064 | `/usr/bin/python3 /home/x/deco/gamma/projects/enwiki9/tools/opcode_event_parse_corpus_v1.py encode /home/x/deco/gamma/projects/enwiki9/operations/ev...` |

## Active Candidate Recent Artifacts

| Path | Bytes | Modified UTC |
|---|---:|---|
| `projects/enwiki9/results/opcode_event_parse_validation250k_q0_v1/P-encode.stdout` | 0 | `2026-09-09T00:33:27+00:00` |
| `projects/enwiki9/results/opcode_event_parse_validation250k_q0_v1/P-encode.stderr` | 0 | `2026-09-09T00:33:27+00:00` |
...
- Active process tree RSS KiB: `509,672`
- Local binary `10GiB` guard KiB: `10,485,760`
- Decimal `10GB` guard KiB: `9,765,625`
- Single-process binary margin KiB: `n/a`
- Single-process decimal margin KiB: `n/a`
- Active process tree margin KiB (binary): `9,976,088`
- Active process tree decimal margin KiB: `9,255,953`
