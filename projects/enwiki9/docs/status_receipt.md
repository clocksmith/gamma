...
- Generated at UTC: `2026-07-27T19:25:38+00:00`
...
- Latest sampled single RSS KiB: `8,610,628`
- Tightest binary single-process margin KiB: `878,396`
- Tightest decimal single-process margin KiB: `158,261`
- Latest binary single-process margin KiB: `1,875,132`
- Latest decimal single-process margin KiB: `1,154,997`
...
- RSS guard JSON modified UTC: `2026-07-27T19:25:37+00:00`
- RSS guard JSON SHA-256: `b897144e9998750019607dbba7051428bb48beefcee6ef792c8b30f591fa5a9a`
- RSS samples: `6,333`
- Max sampled single RSS KiB: `9,607,364`
- Max sampled tree RSS KiB: `9,638,060`
- Single-process RSS margin KiB: `878,396`
- Single-process decimal `10GB` margin KiB: `158,261`
- Tree RSS margin KiB: `847,700`
- Tree decimal `10GB` margin KiB: `127,565`
- Latest sampled single RSS KiB: `8,610,628`
- Latest sampled tree RSS KiB: `8,651,528`
- Latest sampled single-process margin KiB: `1,875,132`
- Latest sampled single-process decimal `10GB` margin KiB: `1,154,997`
- Latest sampled tree margin KiB: `1,834,232`
- Latest sampled tree decimal `10GB` margin KiB: `1,114,097`
...
- Audit return code: `0`
- Program directories: `570`
- Registered programs: `231`
- Untracked nonignored entries: `52`
- Modified tracked entries: `5`
- Candidate statuses: `active=22, blocked_dependency=31, candidate=7, measured_negative=89, retired=414, track_source_before_evolution=7`
...
| `native_cmix` | 332,698 | 265,690 | 8,617,796 | `/tmp/cmix21-mmap-bin-56pc3n75 -t /tmp/cmix21-mmap-dict-zmmck3q4 /tmp/tmpvcizoafb/in /tmp/tmpvcizoafb/out` |

## Active Candidate Recent Artifacts

| Path | Bytes | Modified UTC |
|---|---:|---|
| `projects/enwiki9/results/cmix21_text_mmap_paq5_ppmd20352k_fxcmassoc10_fxcmidx13div2_fxcmrcm20_ppmdguard2_rcm32_bufthirtysecond_minmaps_v1/fxcmassoc10_10000000_exact_rss_guard.json` | 1,392 | `2026-07-27T19:25:37+00:00` |
...
- Max cmix PID: `332698`
- Active cmix mode: `text_compress`
- Max cmix RSS KiB: `8,617,796`
- Active process tree RSS KiB: `8,676,232`
- Local binary `10GiB` guard KiB: `10,485,760`
- Decimal `10GB` guard KiB: `9,765,625`
- Single-process binary margin KiB: `1,867,964`
- Single-process decimal margin KiB: `1,147,829`
- Active process tree margin KiB (binary): `1,809,528`
- Active process tree decimal margin KiB: `1,089,393`
...
- Temp output modified UTC: `2026-07-27T19:23:28+00:00`
- Temp output staging modified UTC: `2026-07-27T19:23:28+00:00`
- Process read bytes: `90,112`
- Process write bytes: `12,378,112`
