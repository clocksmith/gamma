...
- Generated at UTC: `2026-07-27T21:39:13+00:00`
...
- Latest sampled single RSS KiB: `9,599,812`
- Tightest binary single-process margin KiB: `878,396`
- Tightest decimal single-process margin KiB: `158,261`
- Latest binary single-process margin KiB: `885,948`
- Latest decimal single-process margin KiB: `165,813`
...
- RSS guard JSON modified UTC: `2026-07-27T21:39:09+00:00`
- RSS guard JSON SHA-256: `064d38e6f2c8135dfba681a71c0d106927b40ce04bedf1409cb0cda2779aa292`
- RSS samples: `7,935`
- Max sampled single RSS KiB: `9,607,364`
- Max sampled tree RSS KiB: `9,640,712`
- Single-process RSS margin KiB: `878,396`
- Single-process decimal `10GB` margin KiB: `158,261`
- Tree RSS margin KiB: `845,048`
- Tree decimal `10GB` margin KiB: `124,913`
- Latest sampled single RSS KiB: `9,599,812`
- Latest sampled tree RSS KiB: `9,640,712`
- Latest sampled single-process margin KiB: `885,948`
- Latest sampled single-process decimal `10GB` margin KiB: `165,813`
- Latest sampled tree margin KiB: `845,048`
- Latest sampled tree decimal `10GB` margin KiB: `124,913`
...
- Audit return code: `0`
- Program directories: `581`
- Registered programs: `241`
- Untracked nonignored entries: `9`
- Modified tracked entries: `4`
- Candidate statuses: `active=22, blocked_dependency=31, candidate=16, measured_negative=89, retired=422, track_source_before_evolution=1`
...
| `native_cmix` | 332,698 | 265,690 | 9,599,812 | `/tmp/cmix21-mmap-bin-56pc3n75 -t /tmp/cmix21-mmap-dict-zmmck3q4 /tmp/tmpvcizoafb/in /tmp/tmpvcizoafb/out` |

## Active Candidate Recent Artifacts

| Path | Bytes | Modified UTC |
|---|---:|---|
| `projects/enwiki9/results/cmix21_text_mmap_paq5_ppmd20352k_fxcmassoc10_fxcmidx13div2_fxcmrcm20_ppmdguard2_rcm32_bufthirtysecond_minmaps_v1/fxcmassoc10_10000000_exact_rss_guard.json` | 1,392 | `2026-07-27T21:39:14+00:00` |
...
- Max cmix PID: `332698`
- Active cmix mode: `text_compress`
- Max cmix RSS KiB: `9,599,812`
- Active process tree RSS KiB: `9,658,248`
- Local binary `10GiB` guard KiB: `10,485,760`
- Decimal `10GB` guard KiB: `9,765,625`
- Single-process binary margin KiB: `885,948`
- Single-process decimal margin KiB: `165,813`
- Active process tree margin KiB (binary): `827,512`
- Active process tree decimal margin KiB: `107,377`
