...
- Generated at UTC: `2026-09-08T16:55:26+00:00`
...
- Candidate: `opcode_slot_reset_v1`
- Scope bytes: `250,000`
...
- Roundtrip arm: `n/a`
- Coordinator PID: `n/a`
- Driver result JSON: `projects/enwiki9/results/opcode_slot_reset_v1/decision.json`
- Driver result present: `false`
...
- Expected candidate: `opcode_slot_reset_v1`
...
- Expected active candidate: `opcode_slot_reset_v1`
...
- Inventory generated: `2026-09-08T16:55:21+00:00`
- Snapshot identity is verified; inventory inputs were not rescanned. This is not live occupancy or launch authority.
- Program directories: `999`
- Registered programs: `538`
- Untracked nonignored entries: `0`
- Modified tracked entries: `3`
- Candidate statuses: `active=18, blocked_dependency=69, candidate=244, measured_negative=100, retired=568`
...
|---|---:|---:|---:|---|
| `process` | 1,833,051 | 2,643,307 | 41,908 | `python3 tools/enwiki9_lab.py run --candidate opcode_slot_reset_v1 --max-workers 1` |
| `resource_guard` | 1,833,233 | 1,833,051 | 33,324 | `/usr/bin/python3 /home/x/deco/gamma/projects/enwiki9/tools/run_with_resource_guard_v3.py --limit-kib 4194304 --official-decimal-limit-kib 4194304 -...` |
| `process` | 1,833,248 | 1,833,233 | 24,028 | `/usr/bin/python3 /home/x/deco/gamma/projects/enwiki9/tools/opcode_slot_reset_gate_v1.py` |
| `process` | 1,855,370 | 1,833,248 | 361,408 | `/usr/bin/python3 /home/x/deco/gamma/projects/enwiki9/tools/opcode_slot_reset_observe_v1.py encode /home/x/deco/gamma/projects/enwiki9/results/opcod...` |

## Active Candidate Recent Artifacts

| Path | Bytes | Modified UTC |
|---|---:|---|
| `projects/enwiki9/results/opcode_slot_reset_v1/P-repeat.stderr` | 0 | `2026-09-08T16:54:42+00:00` |
| `projects/enwiki9/results/opcode_slot_reset_v1/P-repeat.stdout` | 0 | `2026-09-08T16:54:42+00:00` |
| `projects/enwiki9/results/opcode_slot_reset_v1/P-decode.execution.json` | 862 | `2026-09-08T16:54:42+00:00` |
| `projects/enwiki9/results/opcode_slot_reset_v1/P-decode.audit.json` | 25,864 | `2026-09-08T16:54:42+00:00` |
| `projects/enwiki9/results/opcode_slot_reset_v1/P-decode.stdout` | 125 | `2026-09-08T16:54:42+00:00` |
| `projects/enwiki9/results/opcode_slot_reset_v1/P.raw` | 250,000 | `2026-09-08T16:54:42+00:00` |
| `projects/enwiki9/results/opcode_slot_reset_v1/P-decode.stderr` | 0 | `2026-09-08T16:54:02+00:00` |
| `projects/enwiki9/results/opcode_slot_reset_v1/P-encode.execution.json` | 878 | `2026-09-08T16:54:02+00:00` |
| `projects/enwiki9/results/opcode_slot_reset_v1/P-encode.stdout` | 123 | `2026-09-08T16:54:02+00:00` |
| `projects/enwiki9/results/opcode_slot_reset_v1/P-encode.audit.json` | 25,864 | `2026-09-08T16:54:02+00:00` |
| `projects/enwiki9/results/opcode_slot_reset_v1/P.arc` | 67,658 | `2026-09-08T16:54:02+00:00` |
| `projects/enwiki9/results/opcode_slot_reset_v1/P-encode.stderr` | 0 | `2026-09-08T16:52:50+00:00` |
...
- Active process tree RSS KiB: `460,668`
- Local binary `10GiB` guard KiB: `10,485,760`
- Decimal `10GB` guard KiB: `9,765,625`
- Single-process binary margin KiB: `n/a`
- Single-process decimal margin KiB: `n/a`
- Active process tree margin KiB (binary): `10,025,092`
- Active process tree decimal margin KiB: `9,304,957`
