...
- Generated at UTC: `2026-09-09T01:09:10+00:00`
...
| `resource_guard` | 3,639,172 | 3,639,003 | 33,144 | `/usr/bin/python3 /home/x/deco/gamma/projects/enwiki9/tools/run_with_resource_guard_v3.py --limit-kib 4194304 --official-decimal-limit-kib 4194304 -...` |
| `process` | 3,639,186 | 3,639,172 | 25,900 | `/usr/bin/python3 /home/x/deco/gamma/projects/enwiki9/tools/opcode_event_parse_confirmation_gate_v1.py` |
| `process` | 3,703,640 | 3,639,186 | 251,720 | `/usr/bin/python3 /home/x/deco/gamma/projects/enwiki9/tools/opcode_event_parse_corpus1m_v1.py encode /home/x/deco/gamma/projects/enwiki9/results/opc...` |

## Active Candidate Recent Artifacts

| Path | Bytes | Modified UTC |
|---|---:|---|
| `projects/enwiki9/results/opcode_event_parse_confirmation1m_q0_v1/P-repeat.stderr` | 0 | `2026-09-09T01:09:01+00:00` |
| `projects/enwiki9/results/opcode_event_parse_confirmation1m_q0_v1/P-repeat.stdout` | 0 | `2026-09-09T01:09:01+00:00` |
| `projects/enwiki9/results/opcode_event_parse_confirmation1m_q0_v1/P-decode.execution.json` | 864 | `2026-09-09T01:09:01+00:00` |
| `projects/enwiki9/results/opcode_event_parse_confirmation1m_q0_v1/P-decode.audit.json` | 94,857 | `2026-09-09T01:09:01+00:00` |
| `projects/enwiki9/results/opcode_event_parse_confirmation1m_q0_v1/P-decode.stdout` | 128 | `2026-09-09T01:09:01+00:00` |
| `projects/enwiki9/results/opcode_event_parse_confirmation1m_q0_v1/P.raw` | 1,000,000 | `2026-09-09T01:09:01+00:00` |
| `projects/enwiki9/results/opcode_event_parse_confirmation1m_q0_v1/P-decode.stderr` | 0 | `2026-09-09T01:07:05+00:00` |
| `projects/enwiki9/results/opcode_event_parse_confirmation1m_q0_v1/P-encode.execution.json` | 861 | `2026-09-09T01:07:05+00:00` |
| `projects/enwiki9/results/opcode_event_parse_confirmation1m_q0_v1/P-encode.stdout` | 127 | `2026-09-09T01:07:05+00:00` |
| `projects/enwiki9/results/opcode_event_parse_confirmation1m_q0_v1/P-encode.audit.json` | 94,857 | `2026-09-09T01:07:05+00:00` |
| `projects/enwiki9/results/opcode_event_parse_confirmation1m_q0_v1/P.arc` | 259,468 | `2026-09-09T01:07:05+00:00` |
| `projects/enwiki9/results/opcode_event_parse_confirmation1m_q0_v1/P-encode.stderr` | 0 | `2026-09-09T01:03:22+00:00` |
...
- Active process tree RSS KiB: `353,320`
- Local binary `10GiB` guard KiB: `10,485,760`
- Decimal `10GB` guard KiB: `9,765,625`
- Single-process binary margin KiB: `n/a`
- Single-process decimal margin KiB: `n/a`
- Active process tree margin KiB (binary): `10,132,440`
- Active process tree decimal margin KiB: `9,412,305`
