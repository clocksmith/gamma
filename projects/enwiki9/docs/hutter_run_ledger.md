...
- Objective: `gamma-enwiki9-hutter-99m-v2` (`sha256:16badfa6c1a53b47bcc12b089fdd9c21f7405ea56a84344d60c28d2252da8288`).
- Target: `99,000,000` bytes (`9.9000000%`).
...
| Candidate run | Tier | Status | Population | Archive | Gain | B/M | Package | Forecast | Margin | Proof |
|---|---|---|---|---:|---:|---:|---:|---:|---:|---|
| `endpoint428_gate_dot_fuse_output_update_loop_v1__10000000` | `constructive_prefix` | `active` | opening_prefix | 1,634,500 | 1,195 | 119.500 | 261,125 | 109,389,323 (10.9389323%) | -10,389,323 | RT=true, DET=true |
| `endpoint428_pair_layer0_online_residual_successor__10000000` | `constructive_prefix` | `retired_unchanged` | opening_prefix | 1,635,174 | 521 | 52.100 | 278,825 | 109,452,151 (10.9452151%) | -10,452,151 | not recorded |
| `endpoint428_context_recovery_10m__10000000` | `constructive_prefix` | `retired_unchanged` | unspecified | 1,635,695 | 1,818 | 181.800 | 349,195 | 109,557,404 (10.9557404%) | -10,557,404 | not recorded |
| `heterogeneous_112_plus_80__10000000` | `constructive_prefix` | `retired_unchanged` | unspecified | 1,635,670 | 7,956 | 795.600 | 264,646 | 109,498,879 (10.9498879%) | -10,498,879 | not recorded |
...
| Candidate run | Tier | Status | Population | Archive | Gain | B/M | Package | Forecast | Margin | Proof |
|---|---|---|---|---:|---:|---:|---:|---:|---:|---|
| `wikiir_reference_delta_serializations_v1__2000000` | `proxy` | `retired_unchanged` | unspecified | unknown | -2,976 | -1488.000 | unknown | unknown | unknown | not recorded |

## 1,000,000 Bytes

| Candidate run | Tier | Status | Population | Archive | Gain | B/M | Package | Forecast | Margin | Proof |
|---|---|---|---|---:|---:|---:|---:|---:|---:|---|
| `endpoint428_compact_layer0_phase_native_pruned_v3__1m_prefix` | `constructive_prefix` | `active` | opening_prefix | 174,099 | -136 | -136.000 | 235,420 | 109,499,618 (10.9499618%) | -10,499,618 | RT=true, DET=true |
...
| `endpoint428_pair_layer0_online_residual_successor__1m_offset500m` | `constructive_prefix` | `retired_unchanged` | cold_reset_disjoint_window | 45,051 | 89 | 89.000 | 350,942 | 109,470,151 (10.9470151%) | -10,470,151 | not recorded |
| `endpoint428_pair_layer0_online_residual_successor__1m_prefix` | `constructive_prefix` | `retired_unchanged` | opening_prefix | 173,896 | 67 | 67.000 | 350,942 | 109,492,151 (10.9492151%) | -10,492,151 | RT=true, DET=true |
...
| Candidate run | Tier | Status | Population | Archive | Gain | B/M | Package | Forecast | Margin | Proof |
|---|---|---|---|---:|---:|---:|---:|---:|---:|---|
| `endpoint_diagonal_reservoir_dual_trace_v1__600747` | `causal_shadow` | `historical_control` | unspecified | unknown | 9 | 14.981 | unknown | unknown | unknown | not recorded |

## 500,000 Bytes

| Candidate run | Tier | Status | Population | Archive | Gain | B/M | Package | Forecast | Margin | Proof |
|---|---|---|---|---:|---:|---:|---:|---:|---:|---|
| `wrt_reference_prefix_cts_fx2_v1__500000` | `causal_shadow` | `retired_unchanged` | unspecified | unknown | -1 | -2.000 | unknown | unknown | unknown | not recorded |
| `wrt_normalized_phrase_context_regret_fx2_v1__500000` | `causal_shadow` | `retired_unchanged` | unspecified | unknown | 4 | 8.000 | unknown | unknown | unknown | not recorded |

## 222,281 Bytes

| Candidate run | Tier | Status | Population | Archive | Gain | B/M | Package | Forecast | Margin | Proof |
|---|---|---|---|---:|---:|---:|---:|---:|---:|---|
| `endpoint428_dual112_sixteenth_state_page_shard_v1__222281_prefix` | `constructive_prefix` | `active` | opening_prefix_page_shard_000 | 39,606 | -15 | -67.482 | 261,125 | unknown | unknown | not recorded |
...
| `endpoint428_lstm_alternate_bptt_runtime_proxy_v1__1024` | `proxy` | `retired_unchanged` | opening_prefix | 273 | -1 | -976.562 | unknown | unknown | unknown | not recorded |
