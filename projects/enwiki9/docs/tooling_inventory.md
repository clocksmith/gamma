...
| `harm_delta_horizon_field_entry_observer_q0_v1.py` | Cannot launch a compressor or accept production paths; it executes the snapshot-bound HORIZON-A/GSRT2 field-entry fixture, checks native/reference and A/B identity, pretruth witnesses, measured HGS1 compatibility, frozen production constants, and eight fail-closed corruptions, and emits zero-credit infrastructure evidence. |
| `harm_delta_scope_coordinate_mapper_q0_v1.py` | Cannot launch a compressor or accept production paths; it executes the snapshot-bound Endpoint428 inverse fixture, checks exact raw/WRT/coder lower-bound mapping, complete transcript and future-state digests, native/reference and A/B identity, production constants, and eight fail-closed corruptions, and emits zero-credit infrastructure evidence. |
