...
- Best net receipt: `results/streaming_retrieval_shadow/raw65536k_v1_order2_aggregate_sketch_b640000_s8_complete_blocks.json`
- Best net saved bytes: `884,774`
- Best held-out saved bytes: `897,062`
...
- Target-closing net saved bytes: `884,774`
- Forecast gap remaining after best target-closing receipt: `-203,660`
...
- Ready fallback net saved bytes: `260,560`
- Forecast gap remaining after ready fallback: `420,554`
...
| `results/streaming_retrieval_shadow/raw4096k_v1_order2_aggregate_sketch_b640000_s8.json` | 46,576 | 634,538 | `false` | 0 | `complete_block_audit` |
...
|---|---:|
| `alignment_ok` | 25 |
| `block_regression_within_cap` | 63 |
...
|---|---:|---:|---:|---:|---:|---|
| `streaming_retrieval_raw_shadow_v1 / raw_enwik9_bits_msb` | 56 | 14 | 8 | 884,774 | 897,062 | `results/streaming_retrieval_shadow/raw65536k_v1_order2_aggregate_sketch_b640000_s8_complete_blocks.json` |
...
| `streaming_retrieval_shadow_v2 / projects/enwiki9/results/fx2_residual_cache/apm1m_full_4805936.tsv` | 3 | 0 | 0 | -12,288 | 0 | `results/streaming_retrieval_shadow/fx2_apm1m_cache_rowfeatures_v1_order2_best_band_abstain_sketch_b20000_s8_rows4805936.json` |
...
| `results/streaming_retrieval_shadow/raw1m_no_copy_control_v1.json` | -8,175 | 4,113 | 33,600,000 | `complete` | 2.404 | `false` | `positive_net, block_regression_within_cap` |
