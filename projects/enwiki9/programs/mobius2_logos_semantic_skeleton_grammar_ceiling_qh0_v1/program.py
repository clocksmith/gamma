"""Literal fallback for the LOGOS semantic skeleton grammar QH0 ceiling.

Skeleton definitions, prototypes, and invocations are deliberately supplied
out of band by the ceiling tool. This module preserves a deterministic literal
program contract and receives no score credit.
"""
...
MASK32 = (1 << 32) - 1
BYPASS_MAGIC = b"LGSKELB1"
LITERAL_MAGIC = b"LGSKLT1\0"
