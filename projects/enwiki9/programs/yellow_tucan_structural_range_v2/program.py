"""yellow_tucan_structural_range_v2.

Custom no-cmix/no-lzma arithmetic coder with MediaWiki parser-state contexts.
Raw bytes are unchanged; parser state selects probability tables. V2 adds
trained-context fallback so sparse states do not replace useful lower-order
models while still cold.
"""
