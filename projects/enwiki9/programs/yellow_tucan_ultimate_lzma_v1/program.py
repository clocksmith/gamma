"""yellow_tucan_ultimate_lzma_v1.

No-cmix single-pass feature grammar followed by Python stdlib LZMA:
MediaWiki/XML opcodes, online wiki-link table references, and conservative
numeric semantic codes. One escape grammar is used over the original stream.
"""
