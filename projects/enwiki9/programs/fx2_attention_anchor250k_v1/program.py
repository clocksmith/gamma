...
ID='fx2_attention_anchor250k_v1'
...
def execute(g):
    ...
    child=materialize(members,g.buffers['lib/fx2_attention_anchor_v1.h'])
    ...
    option=len('-DGAMMA_ANCHOR_MODE=1')
    ...
    pricing=dict(deliveries=deliveries,model=g.artifact(native/'models/6m-q4-fp32.tfwc2'),
        ...
        binary_increment_bytes=dp,additional_required_option_bytes=option,
...
def main():
    ...
    result=dict(schema='gamma.enwiki9.attention-anchor-terminal.v1',candidate_id=ID,experiment=g.reference,
