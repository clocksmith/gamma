"""xml_skel_wordcode_lzma_v1 — single-file stripped Phase 1_WC.
...
monolithic lzma over the concatenated typed buffer.
...
WC_MAX_WORD_LEN = 32
WC_MIN_FREQ = 2
WC_WORD_RE = re.compile(rb"[A-Za-z]{%d,%d}" % (WC_MIN_WORD_LEN, WC_MAX_WORD_LEN))
