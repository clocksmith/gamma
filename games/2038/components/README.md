...
1. [world.md](../world.md): the four chapters and ending references. Writing notes
   follow the story.
...
5. [world.json](world.json): the four closing scenes.
...
Keep scenes engaging, institutions distinct, and rules unambiguous. `$scenario`
and `$era` are author notes excluded from play. Shared-name references resolve
