...
mechanics synchronized to executable game `0.8.35`
...
files under `generated/` are generated projections. Executable game `0.8.35`
implements `0.5.0-rc.35-test` while the physical rulebook remains under
review.
...
- test `0.5.0-rc.35-test` under the controlled physical protocol before any
