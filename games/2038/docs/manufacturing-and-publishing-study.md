...
Rules `0.8.0-rc.18-test` are ready for a controlled physical prototype and
are implemented by executable game `0.14.17`. That synchronization is
...
1. Run the controlled four-player `0.8.0-rc.18-test` physical test.
