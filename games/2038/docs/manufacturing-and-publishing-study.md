...
Rules `0.6.0-rc.2-test` are ready for a controlled physical prototype and
are implemented by executable game `0.9.1`. That synchronization is
...
1. Run the controlled four-player `0.6.0-rc.2-test` physical test.
