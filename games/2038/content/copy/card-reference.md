# ${content.worldCopy.title} — Card Reference

This is a generated reading copy of the physical cards. It projects the
canonical card data for a table that needs every card effect in one document.
The physical cards and generated runtime data remain authoritative if a print
mismatch is found.
...
Each board's starts, starting public Mandate, and programs are printed below.

### ${content.factions.byId.coalition_lab.name}

**CEO:** ${content.factions.byId.coalition_lab.chiefExecutive}

**Starts:** ${content.factions.byId.coalition_lab.starts.runway} ${terms.resources.runway}, ${content.factions.byId.coalition_lab.starts.compute} ${terms.resources.compute}, ${content.factions.byId.coalition_lab.starts.capability} ${terms.playerTracks.capability}, ${content.factions.byId.coalition_lab.starts.customers} ${terms.playerTracks.customers}, ${content.factions.byId.coalition_lab.starts.trust} ${terms.playerTracks.trust}, ${content.factions.byId.coalition_lab.starts.safety} ${terms.resources.safety}; ${content.factions.byId.coalition_lab.starts.startingPublicMandate} starting public ${terms.playerTracks.mandate}.
...
**Starts:** ${content.factions.byId.imperial_research_lab.starts.runway} ${terms.resources.runway}, ${content.factions.byId.imperial_research_lab.starts.compute} ${terms.resources.compute}, ${content.factions.byId.imperial_research_lab.starts.capability} ${terms.playerTracks.capability}, ${content.factions.byId.imperial_research_lab.starts.customers} ${terms.playerTracks.customers}, ${content.factions.byId.imperial_research_lab.starts.trust} ${terms.playerTracks.trust}, ${content.factions.byId.imperial_research_lab.starts.safety} ${terms.resources.safety}; ${content.factions.byId.imperial_research_lab.starts.startingPublicMandate} starting public ${terms.playerTracks.mandate}.
...
**Starts:** ${content.factions.byId.vertical_empire.starts.runway} ${terms.resources.runway}, ${content.factions.byId.vertical_empire.starts.compute} ${terms.resources.compute}, ${content.factions.byId.vertical_empire.starts.capability} ${terms.playerTracks.capability}, ${content.factions.byId.vertical_empire.starts.customers} ${terms.playerTracks.customers}, ${content.factions.byId.vertical_empire.starts.trust} ${terms.playerTracks.trust}, ${content.factions.byId.vertical_empire.starts.safety} ${terms.resources.safety}; ${content.factions.byId.vertical_empire.starts.startingPublicMandate} starting public ${terms.playerTracks.mandate}.
...
**Starts:** ${content.factions.byId.safety_laboratory.starts.runway} ${terms.resources.runway}, ${content.factions.byId.safety_laboratory.starts.compute} ${terms.resources.compute}, ${content.factions.byId.safety_laboratory.starts.capability} ${terms.playerTracks.capability}, ${content.factions.byId.safety_laboratory.starts.customers} ${terms.playerTracks.customers}, ${content.factions.byId.safety_laboratory.starts.trust} ${terms.playerTracks.trust}, ${content.factions.byId.safety_laboratory.starts.safety} ${terms.resources.safety}; ${content.factions.byId.safety_laboratory.starts.startingPublicMandate} starting public ${terms.playerTracks.mandate}.
...
**Starts:** ${content.factions.byId.foundry.starts.runway} ${terms.resources.runway}, ${content.factions.byId.foundry.starts.compute} ${terms.resources.compute}, ${content.factions.byId.foundry.starts.capability} ${terms.playerTracks.capability}, ${content.factions.byId.foundry.starts.customers} ${terms.playerTracks.customers}, ${content.factions.byId.foundry.starts.trust} ${terms.playerTracks.trust}, ${content.factions.byId.foundry.starts.safety} ${terms.resources.safety}; ${content.factions.byId.foundry.starts.startingPublicMandate} starting public ${terms.playerTracks.mandate}.
...
- **${content.gameConfig.trainingDeck.cards.0.name}:** ${content.gameConfig.trainingDeck.cards.0.flavorText}
- **${content.gameConfig.trainingDeck.cards.1.name}:** ${content.gameConfig.trainingDeck.cards.1.flavorText}
- **${content.gameConfig.trainingDeck.cards.2.name}:** ${content.gameConfig.trainingDeck.cards.2.flavorText}
- **${content.gameConfig.trainingDeck.cards.3.name}:** ${content.gameConfig.trainingDeck.cards.3.flavorText}
- **${content.gameConfig.trainingDeck.cards.4.name}:** ${content.gameConfig.trainingDeck.cards.4.flavorText}
- **${content.gameConfig.trainingDeck.cards.5.name}:** ${content.gameConfig.trainingDeck.cards.5.flavorText}
- **${content.gameConfig.trainingDeck.cards.6.name}:** ${content.gameConfig.trainingDeck.cards.6.flavorText}
- **${content.gameConfig.trainingDeck.cards.7.name}:** ${content.gameConfig.trainingDeck.cards.7.flavorText}
- **${content.gameConfig.trainingDeck.cards.8.name}:** ${content.gameConfig.trainingDeck.cards.8.flavorText}
- **${content.gameConfig.trainingDeck.cards.9.name}:** ${content.gameConfig.trainingDeck.cards.9.flavorText}
- **${content.gameConfig.trainingDeck.cards.10.name}:** ${content.gameConfig.trainingDeck.cards.10.flavorText}
- **${content.gameConfig.trainingDeck.cards.11.name}:** ${content.gameConfig.trainingDeck.cards.11.flavorText}
