...
export const gameVersionUrl = new URL("../../data/game-version.json", import.meta.url);
...
export async function loadGameIdentity({
  ...
  const version = JSON.parse(await readFile(resolve(root, "data/game-version.json"), "utf8"));
