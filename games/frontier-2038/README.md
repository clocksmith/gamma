...
Executable game `0.8.28` implements that candidate under
...
- `http://localhost:8038/` — play the synchronized `0.8.28` game and export its
  replay.
- `http://localhost:8038/lab` — run `0.8.28` tournaments, strategy evolution,
...
`npm run check` is the release gate. It verifies the executable `0.8.28`
