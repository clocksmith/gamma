...
const required = [
  ...
  "versions/0.8.20/manifest.json",
  "versions/0.8.20/game-bundle.json",
  "versions/0.5.0-rc.21-test/manifest.json",
  "versions/0.5.0-rc.21-test/rules-candidate-bundle.json",
