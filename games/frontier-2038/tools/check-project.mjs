...
const required = [
  ...
  "versions/0.8.14/manifest.json",
  "versions/0.8.14/game-bundle.json",
  "versions/0.5.0-rc.15-test/manifest.json",
  "versions/0.5.0-rc.15-test/rules-candidate-bundle.json",
