...
const required = [
  ...
  "versions/0.8.21/manifest.json",
  "versions/0.8.21/game-bundle.json",
  "versions/0.5.0-rc.22-test/manifest.json",
  "versions/0.5.0-rc.22-test/rules-candidate-bundle.json",
