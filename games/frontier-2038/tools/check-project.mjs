...
const required = [
  ...
  "versions/0.8.11/manifest.json",
  "versions/0.8.11/game-bundle.json",
  "versions/0.5.0-rc.12-test/manifest.json",
  "versions/0.5.0-rc.12-test/rules-candidate-bundle.json",
