...
const required = [
  ...
  "versions/0.8.15/manifest.json",
  "versions/0.8.15/game-bundle.json",
  "versions/0.5.0-rc.16-test/manifest.json",
  "versions/0.5.0-rc.16-test/rules-candidate-bundle.json",
