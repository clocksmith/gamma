...
const required = [
  ...
  "versions/0.8.17/manifest.json",
  "versions/0.8.17/game-bundle.json",
  "versions/0.5.0-rc.18-test/manifest.json",
  "versions/0.5.0-rc.18-test/rules-candidate-bundle.json",
