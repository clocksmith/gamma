...
const required = [
  ...
  "versions/0.8.13/manifest.json",
  "versions/0.8.13/game-bundle.json",
  "versions/0.5.0-rc.14-test/manifest.json",
  "versions/0.5.0-rc.14-test/rules-candidate-bundle.json",
