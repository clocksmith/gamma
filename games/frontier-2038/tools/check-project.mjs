...
const required = [
  ...
  "versions/0.8.16/manifest.json",
  "versions/0.8.16/game-bundle.json",
  "versions/0.5.0-rc.17-test/manifest.json",
  "versions/0.5.0-rc.17-test/rules-candidate-bundle.json",
