...
const required = [
  ...
  "content/README.md",
  "content/graph.json",
  "content/physical/variables.json",
  ...
  "simulation/balance/winning-path.js",
  ...
  "simulation/runtime/create-browser-interactive-game.js",
  "simulation/runtime/interactive-game-core.js",
  ...
  "versions/0.8.24/manifest.json",
  "versions/0.8.24/game-bundle.json",
  "versions/0.5.0-rc.25-test/manifest.json",
  "versions/0.5.0-rc.25-test/rules-candidate-bundle.json",
  ...
  "studies/simulation/preregistrations/faction-prestige-demand-v1.json",
  "studies/simulation/preregistrations/faction-prestige-demand-v1-rules.json",
  "studies/simulation/preregistrations/demis-late-validation-v1.json",
  "studies/simulation/preregistrations/demis-late-validation-v1-rules.json",
  "studies/simulation/preregistrations/demis-peer-validation-v1.json",
  "studies/simulation/preregistrations/demis-peer-validation-v1-rules.json",
  ...
  "studies/simulation/2026-07-28-residual-faction-parity-restart.md",
  "studies/simulation/2026-07-28-residual-parity-telemetry-release.md",
  "studies/simulation/preregistrations/residual-faction-parity-v1.json",
  "studies/simulation/preregistrations/residual-faction-parity-v1-restart.json",
