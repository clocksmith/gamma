...
const required = [
  ...
  "versions/0.8.12/manifest.json",
  "versions/0.8.12/game-bundle.json",
  "versions/0.5.0-rc.13-test/manifest.json",
  "versions/0.5.0-rc.13-test/rules-candidate-bundle.json",
