...
// tests). This is a DERIVED REVIEW VIEW built from data/*.json (the generated
// projections of the content graph); output lands in dist/ (gitignored) and is
// served at /gallery by tools/serve.mjs.
