...
This document contains setting, tone, Era fiction, and ending narratives. It
does not change timing, costs, targets, eligibility, scoring, or any other
mechanical rule. When prose here and rules text appear to conflict, the rules
and printed component text control play.
...
In 2038, intelligence is no longer discussed as a property of minds. It is discussed as capacity, market access, and an item on the quarterly agenda.

Research institutions have become territorial infrastructure companies. Energy ministries negotiate directly with model releases. Public confidence is measured continuously and understood retrospectively.

Six institutions believe they can build the system that history will recognize as general intelligence. None agree on what that means. All agree that somebody else must not announce it first.

## Tone contract

M3T4 2038 uses **solemn institutional absurdity**. Every impossible
technology is presented as a responsible quarterly initiative.

Flavor text may sharpen the escalation but never replaces or modifies a
...
> Nobody knows whether it works. Everyone knows the valuation.

The plausible five-year horizon beyond July 2026. Technology can genuinely improve life. Openness and control, automation and employment, speed and caution all offer credible benefits and harms. Cards name durable directions rather than product launches or already-completed milestones.
...
> The model is no longer the product. Electricity, land, and institutional patience are the product.

The first threshold science fiction. AI becomes an independent economic actor while land, power, chips, and people become an industrial apparatus. Institutions stretch before physics does.
...
> Capability exists. Reality must now be informed.

AI becomes a political constituency and industrializes consensus, legitimacy, ownership, and public reality. Positions harden into blocs; several authenticated publics may occupy the same world.
...
> General intelligence has become a financing category.

Negotiable physics, agent jurisdictions, reality-maintenance systems, personhood, and civilizational declarations become ordinary portfolio decisions. Institutions continue operating after reality stops making sense. The accumulated compromises finally divide into two endings: intelligence remains answerable to a living society, or optimization closes over itself and continues after society is gone.
