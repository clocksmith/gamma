...
**Rules reference:** `0.5.0-rc.11-test`
...
controlled `0.5.0-rc.11-test` test:
...
Executable game `0.8.10` implements `0.5.0-rc.11-test` under engine
...
`0.5.0-rc.11-test` retains the clarification that ring rotation is district
...
The `0.5.0-rc.11-test` candidate and executable `0.8.10` select the three- to
...
Executable `0.8.10` also preserves identity classification:
