...
**Rules reference:** `0.5.0-rc.16-test`
...
controlled `0.5.0-rc.16-test` test:
...
Executable game `0.8.15` implements `0.5.0-rc.16-test` under engine
...
`0.5.0-rc.16-test` retains the clarification that ring rotation is district
...
The `0.5.0-rc.16-test` candidate and executable `0.8.15` select the three- to
...
Executable `0.8.15` also preserves identity classification:
