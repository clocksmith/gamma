...
**Rules reference:** `0.5.0-rc.18-test`
...
controlled `0.5.0-rc.18-test` test:
...
Executable game `0.8.17` implements `0.5.0-rc.18-test` under engine
...
`0.5.0-rc.18-test` retains the clarification that ring rotation is district
...
The `0.5.0-rc.18-test` candidate and executable `0.8.17` select the three- to
...
Executable `0.8.17` also preserves identity classification:
