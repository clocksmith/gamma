...
**Rules reference:** `0.5.0-rc.7-test`
...
controlled `0.5.0-rc.7-test` test:
...
Executable game `0.8.6` implements `0.5.0-rc.7-test` under engine
...
`0.5.0-rc.7-test` retains the clarification that ring rotation is district
...
The `0.5.0-rc.7-test` candidate and executable `0.8.6` select the three- to
...
Executable `0.8.6` also preserves identity classification:
