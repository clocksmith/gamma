...
**Rules reference:** `0.5.0-rc.8-test`
...
controlled `0.5.0-rc.8-test` test:
...
Executable game `0.8.7` implements `0.5.0-rc.8-test` under engine
...
`0.5.0-rc.8-test` retains the clarification that ring rotation is district
...
The `0.5.0-rc.8-test` candidate and executable `0.8.7` select the three- to
...
Executable `0.8.7` also preserves identity classification:
