...
**Rules reference:** `0.5.0-rc.10-test`
...
controlled `0.5.0-rc.10-test` test:
...
Executable game `0.8.9` implements `0.5.0-rc.10-test` under engine
...
`0.5.0-rc.10-test` retains the clarification that ring rotation is district
...
The `0.5.0-rc.10-test` candidate and executable `0.8.9` select the three- to
...
Executable `0.8.9` also preserves identity classification:
