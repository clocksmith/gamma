...
**Rules reference:** `0.5.0-rc.17-test`
...
controlled `0.5.0-rc.17-test` test:
...
Executable game `0.8.16` implements `0.5.0-rc.17-test` under engine
...
`0.5.0-rc.17-test` retains the clarification that ring rotation is district
...
The `0.5.0-rc.17-test` candidate and executable `0.8.16` select the three- to
...
Executable `0.8.16` also preserves identity classification:
