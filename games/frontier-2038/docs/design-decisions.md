...
controlled `0.5.0-rc.19-test` test:
...
Executable game `0.8.18` implements `0.5.0-rc.19-test` under engine
...
`0.5.0-rc.19-test` retains the clarification that ring rotation is district
...
The `0.5.0-rc.19-test` candidate and executable `0.8.18` select the three- to
...
Executable `0.8.18` also preserves identity classification:
