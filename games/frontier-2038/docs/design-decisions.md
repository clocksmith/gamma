...
**Rules reference:** `0.5.0-rc.12-test`
...
controlled `0.5.0-rc.12-test` test:
...
Executable game `0.8.11` implements `0.5.0-rc.12-test` under engine
...
`0.5.0-rc.12-test` retains the clarification that ring rotation is district
...
The `0.5.0-rc.12-test` candidate and executable `0.8.11` select the three- to
...
Executable `0.8.11` also preserves identity classification:
