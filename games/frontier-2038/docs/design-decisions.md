...
**Rules reference:** `0.5.0-rc.15-test`
...
controlled `0.5.0-rc.15-test` test:
...
Executable game `0.8.14` implements `0.5.0-rc.15-test` under engine
...
`0.5.0-rc.15-test` retains the clarification that ring rotation is district
...
The `0.5.0-rc.15-test` candidate and executable `0.8.14` select the three- to
...
Executable `0.8.14` also preserves identity classification:
