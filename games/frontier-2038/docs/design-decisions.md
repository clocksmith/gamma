...
**Rules reference:** `0.5.0-rc.14-test`
...
controlled `0.5.0-rc.14-test` test:
...
Executable game `0.8.13` implements `0.5.0-rc.14-test` under engine
...
`0.5.0-rc.14-test` retains the clarification that ring rotation is district
...
The `0.5.0-rc.14-test` candidate and executable `0.8.13` select the three- to
...
Executable `0.8.13` also preserves identity classification:
