...
**Rules reference:** `0.5.0-rc.13-test`
...
controlled `0.5.0-rc.13-test` test:
...
Executable game `0.8.12` implements `0.5.0-rc.13-test` under engine
...
`0.5.0-rc.13-test` retains the clarification that ring rotation is district
...
The `0.5.0-rc.13-test` candidate and executable `0.8.12` select the three- to
...
Executable `0.8.12` also preserves identity classification:
