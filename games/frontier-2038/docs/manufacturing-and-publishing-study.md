...
Rules `0.5.0-rc.34-test` are ready for a controlled physical prototype and
are implemented by executable game `0.8.34`. That synchronization is
...
1. Run the controlled four-player `0.5.0-rc.34-test` physical test.
