...
Rules `0.5.0-rc.30-test` are ready for a controlled physical prototype and
are implemented by executable game `0.8.30`. That synchronization is
...
1. Run the controlled four-player `0.5.0-rc.30-test` physical test.
