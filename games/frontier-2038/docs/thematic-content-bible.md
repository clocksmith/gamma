...
mechanics synchronized to executable game `0.8.14`
...
files under `data/` are generated projections. Executable game `0.8.14`
implements `0.5.0-rc.15-test` while the physical rulebook remains under
review.
...
- approve or revise `0.5.0-rc.15-test` after controlled play;
