...
**Rules reference:** `0.5.0-rc.29-test`
**Status:** creative authority; fiction synchronized to the review rulebook,
mechanics synchronized to executable game `0.8.29`
...
files under `generated/` are generated projections. Executable game `0.8.29`
implements `0.5.0-rc.29-test` while the physical rulebook remains under
review.
...
- test `0.5.0-rc.29-test` under the controlled physical protocol before any
