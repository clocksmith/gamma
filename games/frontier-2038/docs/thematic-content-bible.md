...
mechanics synchronized to executable game `0.8.30`
...
files under `generated/` are generated projections. Executable game `0.8.30`
implements `0.5.0-rc.30-test` while the physical rulebook remains under
review.
...
- test `0.5.0-rc.30-test` under the controlled physical protocol before any
