...
**Rules reference:** `0.5.0-rc.31-test`
**Status:** creative authority; fiction synchronized to the review rulebook,
mechanics synchronized to executable game `0.8.31`
...
files under `generated/` are generated projections. Executable game `0.8.31`
implements `0.5.0-rc.31-test` while the physical rulebook remains under
review.
...
- test `0.5.0-rc.31-test` under the controlled physical protocol before any
