...
mechanics synchronized to executable game `0.8.7`
...
files under `data/` are generated projections. Executable game `0.8.7`
implements `0.5.0-rc.8-test` while the physical rulebook remains under
review.
...
- approve or revise `0.5.0-rc.8-test` after controlled play;
