...
mechanics synchronized to executable game `0.8.21`
...
files under `data/` are generated projections. Executable game `0.8.21`
implements `0.5.0-rc.22-test` while the physical rulebook remains under
review.
...
- test `0.5.0-rc.22-test` under the controlled physical protocol before any
