...
mechanics synchronized to executable game `0.8.12`
...
files under `data/` are generated projections. Executable game `0.8.12`
implements `0.5.0-rc.13-test` while the physical rulebook remains under
review.
...
- approve or revise `0.5.0-rc.13-test` after controlled play;
