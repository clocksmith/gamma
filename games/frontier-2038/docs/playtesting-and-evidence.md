...
**Rules under review:** `0.5.0-rc.9-test`
...
`docs/core-rules.md` is a review draft at `0.5.0-rc.9-test`. Executable
game `0.8.8` implements it under `three-to-five-grid-ready-v1`. New automated reports
...
Executable `0.8.8` retains write-only decision capture and paired read-only
...
Candidate `0.5.0-rc.9-test` and executable `0.8.8` select three to five
