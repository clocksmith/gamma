...
**Rules under review:** `0.5.0-rc.29-test`
...
`docs/core-rules.md` is a review draft at `0.5.0-rc.29-test`. Executable
game `0.8.29` implements it under `three-to-five-grid-ready-v1`. New automated reports
