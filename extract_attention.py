...
def main():
    ...
    if last_idx not in canvas_indices:
        print(f"Last Token {last_idx} ({engine.get_token_text(input_ids_list[last_idx])}) attention distribution:")
