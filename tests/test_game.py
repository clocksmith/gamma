...
try:
    from src.game import cli as game
...
class TestGameRefactor(unittest.TestCase):
    ...
    @patch('src.game.cli.run_tutorial_mode')
    ...
    @patch('src.game.cli.run_comparison_mode')
    ...
    @patch('src.game.cli.run_meld_mode')
    ...
    @patch('src.game.cli.initialize_game_engine')
    @patch('src.game.cli.run_game_loop')
