...
OUTPUT_FILE = "canvas_attention_data.json"
...
def main():
    print(f"💀 Loading {MODEL_NAME}... (RIP RAM)")
    ...
    print("\n🎨 Painting the Slop on the Canvas...\n")
    ...
    print(f"\n💾 Dumping Artifacts to {OUTPUT_FILE}...")
    
    with open(OUTPUT_FILE, "w") as f:
        json.dump(export_data, f, indent=2)

    print("✅ Done. The Canvas is ready.")
